    ...
    class uDrawCustomerDesigns extends uDrawAjaxBase {                
        ...
        function duplicate_customer_design($access_key = "") { 
            ...
            if (file_exists($designFilePath)) {
                ...
                $designFilePath = str_replace(WP_CONTENT_DIR, WP_CONTENT_URL, $designFile);
                $get_design_data =  $uDrawUtil->get_web_contents($designFilePath);
        ...
        function remove_customer_design($access_key = "") {
            ...
            if (isset($_REQUEST['customer_id'])) {
                $customer_id = $uDrawUtil->sanitize_variables($_REQUEST['customer_id']);
            }
