    ...
    class uDrawSettings {
        ...
        public function get_setting($name) {
            ...
            if (array_key_exists($name, $settings)) {
                $value = uDrawUtil::sanitize_variables($settings[$name]);
            }
            return $value;
        }
        ...
        public function get_settings() {
            ...
            $default_settings['gosendex_group_order_files'] = false;
            ...
            $default_settings['udraw_price_matrix_allowed_file_types'] = $validExt;
            $default_settings['udraw_price_matrix_upload_min_dpi'] = 150;
            $default_settings['goepower_submit_on_status'] = "submitted";
        ...
        public function update_settings() {
            if (isset($_POST['save_udraw_settings']) ) {                
                $setting_tab = (isset($_GET['tab'])) ? uDrawUtil::sanitize_variables($_GET['tab']) : 'general';
                $settings = $this->get_settings();
                switch ( $setting_tab ) {
                    case "general":
                        // General Settings                    
                        ...
                        break;
                    case "designer-ui" :
                        $settings['udraw_designer_language'] = uDrawUtil::sanitize_variables($_POST['udraw_designer_language']);
                        $settings['udraw_designer_display_orientation'] = uDrawUtil::sanitize_variables($_POST['udraw_designer_display_orientation']);
                    ...
                    case "social_media":
                        ...
                        $settings['designer_facebook_app_id'] = uDrawUtil::sanitize_variables($_POST['designer_facebook_app_id']);
                        
                        $settings = $this->__setBooleanFromPost($settings, 'designer_enable_instagram_functions');
                        $settings['designer_instagram_client_id'] = uDrawUtil::sanitize_variables($_POST['designer_instagram_client_id']);
                        
                        $settings = $this->__setBooleanFromPost($settings, 'designer_enable_flickr_functions');
                        $settings['designer_flickr_client_id'] = uDrawUtil::sanitize_variables($_POST['designer_flickr_client_id']);
                        $settings['designer_flickr_secret_id'] = uDrawUtil::sanitize_variables($_POST['designer_flickr_secret_id']);
                        
                        $settings = $this->__setBooleanFromPost($settings, 'designer_enable_google_functions');
                        $settings['designer_google_api_key'] = uDrawUtil::sanitize_variables($_POST['designer_google_api_key']);
                        $settings['designer_google_client_id'] = uDrawUtil::sanitize_variables($_POST['designer_google_client_id']);
                        break;
                    case "price_matrix":
                        $settings['udraw_price_matrix_placement'] = '';
                        if ($_POST['price_matrix_placement'] === 'custom') {
                            $settings['udraw_price_matrix_placement'] = uDrawUtil::sanitize_variables($_POST['price_matrix_placement_input']);
                        } 
                        $settings['udraw_price_matrix_settings_placement'] = uDrawUtil::sanitize_variables($_POST['price_matrix_settings_placement']);
                        ...
                        $settings = $this->__setNKVFromPost($settings, 'udraw_price_matrix_allowed_file_types');
                        $settings['udraw_price_matrix_upload_min_dpi'] = uDrawUtil::sanitize_variables($_POST['udraw_price_matrix_upload_min_dpi']);
                        break;
                    case "gosendex" :
                        $settings['gosendex_api_key'] = uDrawUtil::sanitize_variables($_POST['gosendex_api_key']);
                        $settings['gosendex_send_file_after_order'] = uDrawUtil::sanitize_variables($_POST['gosendex_send_file_after_order']);
                        $settings['gosendex_group_order_files'] = uDrawUtil::sanitize_variables($_POST['gosendex_group_order_files']);
                        $settings['gosendex_send_email_after_order_sent'] = uDrawUtil::sanitize_variables($_POST['gosendex_send_email_after_order_sent']);
                        $settings['gosendex_email_to_send_notification'] = uDrawUtil::sanitize_variables($_POST['gosendex_email_to_send_notification']);
                        $settings['gosendex_domain'] = uDrawUtil::sanitize_variables($_POST['gosendex_domain']);
                        break;
                    case "goepower" :
                        $settings['goepower_username'] = sanitize_user($_POST['goepower_username']);
                        if (strlen($_POST['goepower_password']) > 0) {
                            $settings['goepower_password'] = uDrawUtil::sanitize_variables($_POST['goepower_password']);
                        }
                        $settings['goepower_api_key'] = uDrawUtil::sanitize_variables($_POST['goepower_api_key']);
                        $settings['goepower_producer_id'] = uDrawUtil::sanitize_variables($_POST['goepower_producer_id']);
                        $settings['goepower_company_id'] = uDrawUtil::sanitize_variables($_POST['goepower_company_id']);
                        $settings = $this->__setBooleanFromPost($settings, 'goepower_send_file_after_order');
                        $settings['goepower_additional_notify_email'] = uDrawUtil::sanitize_variables($_POST['goepower_additional_notify_email']);
                        $settings = $this->__setBooleanFromPost($settings,'goepower_pdf_preview_auto_update');
                        $settings['goepower_preview_mode'] = uDrawUtil::sanitize_variables($_POST['goepower_preview_mode']);
                        $settings['goepower_approve_button_placement'] = uDrawUtil::sanitize_variables($_POST['goepower_approve_button_placement']);
                        $settings['goepower_submit_on_status'] = uDrawUtil::sanitize_variables($_POST['goepower_submit_on_status']);
                        ...
                        $settings['goepower_designer_location'] = uDrawUtil::sanitize_variables($_POST['goepower_designer_location']);
                        $settings['loading_animation_link'] = uDrawUtil::sanitize_variables($_POST['loading_animation_link']);
                        $settings['approve_proof_text'] = uDrawUtil::sanitize_variables($_POST['approve_proof_text']);
                        break;
                    case "activation" :
