    ...
    <?php } else { ?>
        ...
        <form class="cart" method="post" enctype="multipart/form-data" >
            ...
            <p>
                ...
                <span id="product_total_price"><?php echo uDrawUtil::esc_string($product->get_price()); ?></span>
            </p>
            <button type="button" data-udraw="cart_btn" class="btn btn-success">
                <i class="fas fa-shopping-cart"></i>
                <span class="left_space"><?php echo uDrawUtil::esc_string($product->single_add_to_cart_text()); ?></span>
            </button>
            <?php } ?>
        </form>
        <?php } ?>
