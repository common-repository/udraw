...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark row" data-udraw="designerMenu">
    <div class="col-8">
        ...
        <?php } else { ?>
            ...
            <div class="dropdown">
                <button class="btn bg-light dropdown-toggle" type="button" data-bs-toggle="dropdown"
            ...
            <button class="btn bg-light toggle_pages_layers" style="display: none;">
    ...
    <div class="col-4 text-right" data-udraw="versionContainer">
        <button id="full-screen" type="button" class="btn btn-success">
            ...
            <span class="desktop_only left_space" data-i18n="[html]menu_label.fullscreen"></span>
        </button>
...
<div class="body_block">
        ...
        <div class="dropdown dropright">
            ...
            <div class="dropdown-menu">
                ...
                <a class="dropdown-item" data-udraw="addCurvedText" href="#">
                    <img src="<?php echo uDrawUtil::esc_string(UDRAW_DESIGNER_IMG_PATH); ?>arc-text-black.png" style="margin-top: -10px;" />
    ...
    <!-- Tools Container -->
    <div class="tools_container col-11 col-lg-4" id="tools-container">
        <!-- Tools -->
        <div data-udraw="toolsModal">
            <button type="button" class="btn bg-light btn-outline-secondary" data-bs-toggle="collapse" data-bs-target="#tools"
            ...
            <div id="tools" class="collapse multi-collapse">
                ...
                <div class="btn-group">
                    <a href="#" class="btn btn-secondary tool-btn" data-udraw="objectsAlignLeft"><img src="<?php echo uDrawUtil::esc_string(UDRAW_DESIGNER_IMG_PATH); ?>align-left-white.png" alt="Align Left" /></a>
                    <a href="#" class="btn btn-secondary tool-btn" data-udraw="objectsAlignCenter"><img src="<?php echo uDrawUtil::esc_string(UDRAW_DESIGNER_IMG_PATH); ?>align-horizontal-middle-white.png" alt="Align Center" /></a>
                    <a href="#" class="btn btn-secondary tool-btn" data-udraw="objectsAlignRight"><img src="<?php echo uDrawUtil::esc_string(UDRAW_DESIGNER_IMG_PATH); ?>align-right-white.png" alt="Align Right" /></a>
                    <a href="#" class="btn btn-secondary tool-btn" data-udraw="objectsAlignTop"><img src="<?php echo uDrawUtil::esc_string(UDRAW_DESIGNER_IMG_PATH); ?>align-top-white.png" alt="Align Top" /></a>
                    <a href="#" class="btn btn-secondary tool-btn" data-udraw="objectsAlignMiddle"><img src="<?php echo uDrawUtil::esc_string(UDRAW_DESIGNER_IMG_PATH); ?>align-vertical-middle-white.png" alt="Align Middle" /></a>
                    <a href="#" class="btn btn-secondary tool-btn" data-udraw="objectsAlignBottom"><img src="<?php echo uDrawUtil::esc_string(UDRAW_DESIGNER_IMG_PATH); ?>align-bottom-white.png" alt="Align Bottom" /></a>
                </div>
                <div class="btn-group">
                    <a href="#" class="btn btn-secondary tool-btn" data-udraw="undoButton"><i class="fas fa-undo"></i></a>
                    <a href="#" class="btn btn-secondary tool-btn" data-udraw="redoButton"><i class="fas fa-redo"></i></a>
                    <a href="#" class="btn btn-secondary tool-btn" data-udraw="removeButton"><i class="far fa-trash-alt"></i></a>
                    <a href="#" class="btn btn-secondary tool-btn" data-udraw="duplicateButton"><i class="far fa-copy"></i></a>
                </div>
                <div class="row">
                    <div class="col-6 text-center">
                        ...
                        <p><span data-udraw="objectScaleLabel"></span><span>x</span></p>
                    </div>
                    <div class="col-6 text-center">
                        <div class="btn-group">
                        ...
                        <p><span data-udraw="objectRotationLabel"></span><span>º</span></p>
                    </div>
                    <div class="col-6 text-center">
        ...
        <div data-udraw="textModal">
            <button type="button" class="btn bg-light btn-outline-secondary" data-bs-toggle="collapse" data-bs-target="#text-container"
                    aria-expanded="false" aria-controls="text-container" data-i18n="[html]common_label.text">
                Text
            </button>
            <div id="text-container" data-udraw="text_tools_container" class="collapse multi-collapse">
        ...
        <div class="modal tools_modal" data-udraw="shadowModal">
            <button type="button" class="btn bg-light btn-outline-secondary" data-bs-toggle="collapse" data-bs-target="#shadow"
        ...
        <div class="modal tools_modal" data-udraw="gradientModal">
            <button type="button" class="btn bg-light btn-outline-secondary" data-bs-toggle="collapse" data-bs-target="#gradient"
        ...
        <div class="modal tools_modal" data-udraw="imageFilterModal">
            <button type="button" class="btn bg-light btn-outline-secondary" data-bs-toggle="collapse" data-bs-target="#imageFilters"
        ...
        <div class="modal tools_modal" data-udraw="imageColouringModal">
            <button type="button" class="btn bg-light btn-outline-secondary" data-bs-toggle="collapse" data-bs-target="#svgColouring"
        ...
        <div class="modal tools_modal" data-udraw="imageClippingModal">
            <button type="button" class="btn bg-light btn-outline-secondary" data-bs-toggle="collapse" data-bs-target="#imageClipping"
        ...
        <div data-udraw="boundingBoxModal">
            <button type="button" class="btn bg-light btn-outline-secondary" data-bs-toggle="collapse" data-bs-target="#boundingBox"
        ...
        <div data-udraw="layersModal">
            <button type="button" class="btn bg-light btn-outline-secondary" data-bs-toggle="collapse" data-bs-target="#layers"
        ...
        <div class="modal tools_modal" data-udraw="linkedTemplatesModal">
            <button type="button" class="btn bg-light btn-outline-secondary" data-bs-toggle="collapse" data-bs-target="#linkedTemplates"
        ...
        <div class="modal tools_modal" data-udraw="layerLabelsModal">
            <button type="button" class="btn bg-light btn-outline-secondary" data-bs-toggle="collapse" data-bs-target="#labels"
        ...
        <div class="modal tools_modal" data-udraw="multilayerImageModal">
            <button type="button" class="btn bg-light btn-outline-secondary" data-bs-toggle="collapse" data-bs-target="#layered_image"
        ...
        <div>
            <button type="button" class="btn bg-light btn-outline-secondary" data-bs-toggle="collapse" data-bs-target="#background_container"
                    aria-expanded="false" aria-controls="pages" data-i18n="[html]menu_label.background">
            </button>
            <div id="background_container" data-udraw="background_container" class="collapse multi-collapse">
        ...
        <div>
            <button type="button" class="btn bg-light btn-outline-secondary" data-bs-toggle="collapse" data-bs-target="#pages_section"
                    aria-expanded="false" aria-controls="pages" data-i18n="[html]common_label.pages">
            </button>
            <div id="pages_section" data-udraw="pages_section" class="collapse multi-collapse">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="topRightContainer">
                    <a href="#" data-bs-dismiss="modal"><span data-i18n="[html]common_label.close"></span></a>
                </div>
            </div>
            ...
            <div class="modal-footer toolbox-footer">
                <a href="#" class="btn btn-danger" data-bs-dismiss="modal" data-udraw="polygonCancel"><span data-i18n="[html]common_label.cancel"></span></a>
...
<div class="modal overlay-modal" role="dialog" aria-labelledby="qrModal" aria-hidden="true" data-udraw="qrModal">
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger" data-bs-dismiss="modal" data-i18n="[html]common_label.close"></button>
                            ...
                            <li class="col-4">
                                <div class="thumbnail">
                                    <a href="#" onclick="RacadDesigner.Wizard.ShowProductOptions('bc');">
                                        ...
                                        <img src="<?php echo uDrawUtil::esc_string(UDRAW_DESIGNER_IMG_PATH); ?>wizard/BC.png" />
                                    </a>
                                </div>
                            </li>
                            <li class="col-4">
                                <div class="thumbnail">
                                    <a href="#" onclick="RacadDesigner.Wizard.ShowProductOptions('brochure');">
                                        ...
                                        <img src="<?php echo uDrawUtil::esc_string(UDRAW_DESIGNER_IMG_PATH); ?>wizard/Brochures.png" />
                                    </a>
                                </div>
                            </li>
                            <li class="col-4">
                                <div class="thumbnail">
                                    <a href="#" onclick="RacadDesigner.Wizard.ShowProductOptions('envelope');">
                                        ...
                                        <img src="<?php echo uDrawUtil::esc_string(UDRAW_DESIGNER_IMG_PATH); ?>wizard/Envelopes.png" />
                                    </a>
                                </div>
                            </li>
                            <li class="col-4">
                                <div class="thumbnail">
                                    <a href="#" onclick="RacadDesigner.Wizard.ShowProductOptions('flyers');">
                                        ...
                                        <img src="<?php echo uDrawUtil::esc_string(UDRAW_DESIGNER_IMG_PATH); ?>wizard/Flyers.png" />
                                    </a>
                                </div>
                            </li>
                            <li class="col-4">
                                <div class="thumbnail">
                                    <a href="#" onclick="RacadDesigner.Wizard.ShowProductOptions('gc');">
                                        ...
                                        <img src="<?php echo uDrawUtil::esc_string(UDRAW_DESIGNER_IMG_PATH); ?>wizard/GreetingsCards.png" />
                                    </a>
                                </div>
                            </li>
                            <li class="col-4">
                                <div class="thumbnail">
                                    <a href="#" onclick="RacadDesigner.Wizard.ShowProductOptions('lh');">
                                        ...
                                        <img src="<?php echo uDrawUtil::esc_string(UDRAW_DESIGNER_IMG_PATH); ?>wizard/Letterheads.png" />
                                    </a>
                                </div>
                            </li>
                            <li class="col-4">
                                <div class="thumbnail">
                                    <a href="#" onclick="RacadDesigner.Wizard.ShowProductOptions('postcard');">
                                        ...
                                        <img src="<?php echo uDrawUtil::esc_string(UDRAW_DESIGNER_IMG_PATH); ?>wizard/Postcard.png" />
                                    </a>
                                </div>
                            </li>
                            <li class="col-4">
                                <div class="thumbnail">
                                    <a href="#" onclick="RacadDesigner.Wizard.ShowProductOptions('custom');">
                                        ...
                                        <img src="<?php echo uDrawUtil::esc_string(UDRAW_DESIGNER_IMG_PATH); ?>wizard/Upload.png" />
                                    </a>
                                </div>
                            </li>
                        </ul>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <ul class="nav nav-tabs settings_tabs">
                    <li class="nav-item">
                        <button class="nav-link active" id="document-tab-btn" data-bs-toggle="tab" data-bs-target="#document-tab" type="button" role="tab" aria-controls="document" aria-selected="true">Document Size</button>
                    </li>
                    <li class="nav-item">
                        <button class="nav-link" id="restrict-tab-btn" data-bs-toggle="tab" data-bs-target="#restrict-tab" type="button" role="tab" aria-controls="restrict" aria-selected="false">Restrict/Disable Features</button>
                    </li>
                    <li class="nav-item">
                        <button class="nav-link" id="labels-tab-btn" data-bs-toggle="tab" data-bs-target="#labels-tab" type="button" role="tab" aria-controls="labels" aria-selected="false">Object Labels</button>
                    </li>
                </ul>
                <div class="tab-content">
                    <div class="tab-pane active" role="tabpanel" id="document-tab" aria-labelledby="document-tab">
                        <form class="form-horizontal" role="form">
                            <div class="form-group">
                                ...
                                <div class="checkbox checkbox col-sm-11 document-settings-container">
                                    <span data-i18n="[html]text.measurement-unit"></span>
                                    <select data-udraw="selectMeasurementUnit">
                                ...
                                <div class="checkbox checkbox col-sm-11 document-settings-container">
                                    <span class="settings-heading" data-i18n="[html]text.canvas-pdf-ratio"></span>
                                    <br />
                                    ...
                                    <br />
                                    <hr/>
                                    <div class="pdf-dimensions-container">
                                        <span class="settings-heading" data-i18n="[html]text.settings-pdf-dimensions" style="font-weight: bold;"></span><br />
                                ...
                                <hr/>
                                <div class="checkbox checkbox col-sm-11">
                                    <label>
                    ...
                    <div class="tab-pane" role="tabpanel" id="restrict-tab" aria-labelledby="restrict-tab">
                        <div data-udraw="restrictDisableContainer"></div>
                    </div>
                    <div class="tab-pane" role="tabpanel" id="labels-tab" aria-labelledby="labels-tab">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger" data-bs-dismiss="modal" data-i18n="[html]common_label.cancel"></button>
...
<div class="modal overlay-modal" role="dialog" aria-labelledby="cropModal" aria-hidden="true" data-udraw="cropModal">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger" data-bs-dismiss="modal" data-udraw="crop_cancel" data-i18n="[html]common_label.cancel"></button>
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-body" style="text-align: center;">
                ...
                <button type="button" class="button" data-bs-dismiss="modal" data-i18n="[html]common_label.no" data-udraw="not_load_saved_xml"></button>
            </div>
        </div>
    </div>
</div>
