                    ...
                    <li>
                        ...
                        <form class="cart" method="post" enctype="multipart/form-data">
                            ...
                            <div style="display: inline; vertical-align: middle; color:#fff; float:left; line-height:2.5;">
                                ...
                                <span id="product_total_price" style="font-size:1.5em; vertical-align:middle;"><?php echo uDrawUtil::esc_string($product->get_price()); ?></span>
                ...
                <div class="float-toolbar">
                    <div class="inner-div" style="padding: 1px;">
                        <div class="text-items">
                            <div class="btn-group" data-bs-toggle="tooltip-top" data-i18n="[data-original-title]tooltip.font-style" data-udraw="fontFamilyContainer">
                            ...
                            <div class="btn-group" data-bs-toggle="tooltip-top" data-i18n="[data-original-title]tooltip.font-size" 
                            ...
                            <div class="btn-group" data-udraw="fontStyleContainer">
                                <button type="button" class="dropdown-toggle designer-toolbar-btn" data-bs-toggle="dropdown">
                        ...
                        <div data-udraw="designerColourContainer">
                            <input type="text" value="#000000" data-opacity="1" class="standard-js-colour-picker text-colour-picker" 
                                   style="background-color: rgb(255, 255, 255);" data-bs-toggle="tooltip-top" data-i18n="[data-original-title]tooltip.object-colour-picker" 
                        ...
                        <div class="btn-group" data-udraw="objectAlignContainer">
                            ...
                            <ul class="dropdown-menu" role="menu" style="min-width: 95px;">
                                <li>
                                    <a href="#" data-udraw="objectsAlignLeft"><img src="<?php echo uDrawUtil::esc_string(UDRAW_DESIGNER_IMG_PATH) ?>bg_btn_align_left.png" alt="Align Left" /></a>
                                    <a href="#" data-udraw="objectsAlignCenter"><img src="<?php echo uDrawUtil::esc_string(UDRAW_DESIGNER_IMG_PATH) ?>bg_btn_align_center.png" alt="Align Center" /></a>
                                    <a href="#" data-udraw="objectsAlignRight"><img src="<?php echo uDrawUtil::esc_string(UDRAW_DESIGNER_IMG_PATH) ?>bg_btn_align_right.png" alt="Align Right" /></a>
                                </li>
                                <li>
                                    <a href="#" data-udraw="objectsAlignTop"><img src="<?php echo uDrawUtil::esc_string(UDRAW_DESIGNER_IMG_PATH) ?>bg_btn_align_top.png" alt="Align Top" /></a>
                                    <a href="#" data-udraw="objectsAlignMiddle"><img src="<?php echo uDrawUtil::esc_string(UDRAW_DESIGNER_IMG_PATH) ?>bg_btn_align_middle.png" alt="Align Middle" /></a>
                                    <a href="#" data-udraw="objectsAlignBottom"><img src="<?php echo uDrawUtil::esc_string(UDRAW_DESIGNER_IMG_PATH) ?>bg_btn_align_bottom.png" alt="Align Bottom" /></a>
                                </li>
                                <li>
                        ...
                        <?php } ?>
                        <button type="button" data-bs-toggle="tooltip-top" data-i18n="[data-original-title]tooltip.delete" data-udraw="removeButton">
                            ...
                            <div>
                                ...
                                <div style="display:none;" data-udraw="curvedTextContainer">
                                    ...
                                    <div style="padding: 5px;">
                                        <div style="width: 20%; display:inline-block;" data-bs-toggle="tooltip-top" data-i18n="[data-original-title]tooltip.curved-text-spacing">
                                    ...
                                    <div style="padding: 5px;">
                                        <div style="width: 20%; display:inline-block;" data-bs-toggle="tooltip-top" data-i18n="[data-original-title]tooltip.curved-text-radius">
                                    ...
                                    <div style="padding: 5px;">
                                        <div style="width: 20%; display:inline-block;" data-bs-toggle="tooltip-top" data-i18n="[data-original-title]tooltip.curved-text-starting-angle">
                        ...
                        <div>
                            <div class="element-btn col-xs-2">
                                <a href="#" data-udraw="addCircle">
                                    ...
                                    <img src="<?php echo uDrawUtil::esc_string(UDRAW_DESIGNER_IMG_PATH) ?>circle-icon.png" class="shape-icon" />
                                    <span data-i18n="[html]menu_label.circle"></span>
                                </a>
                            </div>
                            <div class="element-btn col-xs-2">
                                <a href="#" data-udraw="addRectangle">
                                    <img src="<?php echo uDrawUtil::esc_string(UDRAW_DESIGNER_IMG_PATH) ?>square-icon.png" class="shape-icon" />
                                    <span data-i18n="[html]menu_label.rect"></span>
                                </a>
                            </div>
                            <div class="element-btn col-xs-2">
                                <a href="#" data-udraw="addTriangle">
                                    <img src="<?php echo uDrawUtil::esc_string(UDRAW_DESIGNER_IMG_PATH) ?>triangle-icon.png" class="shape-icon" />
                                    <span data-i18n="[html]menu_label.triangle"></span>
                                </a>
                            </div>
                            <div class="element-btn col-xs-2">
                                <a href="#" data-udraw="addLine">
                                    <img src="<?php echo uDrawUtil::esc_string(UDRAW_DESIGNER_IMG_PATH) ?>line-icon.png" class="shape-icon" />
                                    <span data-i18n="[html]menu_label.line"></span>
                                </a>
                            </div>
                            <div class="element-btn col-xs-2">
                                <a href="#" data-udraw="addCurvedLine">
                                    <img src="<?php echo uDrawUtil::esc_string(UDRAW_DESIGNER_IMG_PATH) ?>curved-line-icon.png" class="shape-icon" />
                                    <span data-i18n="[html]menu_label.curved_line"></span>
                                </a>
                            </div>
                            <div class="element-btn col-xs-2">
                                <a href="#" data-udraw="addPolygon">
                                    <img src="<?php echo uDrawUtil::esc_string(UDRAW_DESIGNER_IMG_PATH) ?>octagon-icon.png" class="shape-icon" />
                                    <span data-i18n="[html]menu_label.polyshape"></span>
                                </a>
                            </div>
                            <div class="element-btn col-xs-2">
                                <a href="#" data-udraw="addStar">
                                    <img src="<?php echo uDrawUtil::esc_string(UDRAW_DESIGNER_IMG_PATH) ?>star-icon.png" class="shape-icon" />
...
<script>
    var isUpdate = (<?php echo uDrawUtil::esc_string($isUpdate); ?> === true) ? true : false ;
    var designing = false;
