                ...
                <div class="right">
                    ...
                    <?php } else { ?>
                        <form class="cart" method="post" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="add-to-cart" value="<?php echo uDrawUtil::esc_string( $product->get_id() ); ?>">
                            ...
                            <a href="#" id="simple-add-to-cart-btn" data-udraw="cart_btn" class="btn btn-success designer-menu-btn" style="margin-top: -1px;">
                                ...
                                <span>&nbsp;<?php echo uDrawUtil::esc_string($product->single_add_to_cart_text()); ?></span>
                            </a>
                        </form>
                    <?php } ?>
                </div>
                            ...
                            <?php if ($isPriceMatrix) { ?>
                                ...
                                <?php if ($allowUploadArtwork === "yes") { ?>
                                    ...
                                    <input style="display: none; visibility: hidden; width: 0; height: 0;" id="fileuploadA" 
                                           type="file" name="files[]" accept="<?php echo uDrawUtil::esc_string($valid_extensions) ?>" multiple>
                                    <?php if ($allowDoubleUploadArtwork === "yes") { ?>
...
<!--                                        <option value="clipart">Clipart</option>-->
                    ...
                    <div data-udraw="top_toolbar_container">
                        <div data-udraw="top_toolbar">
                            <div class="text_tools">
                                ...
                                <div>
                                    <a href="#" class="text_buttons text_area_button dropdown-toggle" data-bs-toggle="dropdown"
                                ...
                                <div data-udraw="fontStyleContainer">
                                    <a href="#" class="text_buttons" data-udraw="font_styles_btn" data-bs-toggle="dropdown"><i class="fas fa-bold"></i></a>
                                ...
                                <div data-udraw="fontAlignContainer">
                                    <a href="#" class="text_buttons" data-udraw="font_align_btn" data-bs-toggle="dropdown"><i class="fas fa-align-left"></i></a>
                                ...
                                <div data-udraw="letter_spacing_container">
                                    <a href="#" class="text_buttons" data-bs-toggle="dropdown"><i class="fas fa-font"></i><i class="fas fa-arrows-alt-h" style="font-size: 0.75em;"></i><i class="fas fa-bold"></i></a>
                                ...
                                <div data-udraw="curved_text_container">
                                    <a href="#" class="text_buttons" data-bs-toggle="dropdown"><i class="fas fa-font"></i><i class="fas fa-circle-notch"></i></a>
                                    <div class="dropdown-menu">
                            ...
                            <div class="general_tools">
                                <a href="#" data-udraw="colour_picker_btn" data-bs-toggle="dropdown"><div></div></a>
                                <div class="dropdown-menu">
                                    <div class="colour_container">
                    ...
                    <div class="footer">
                        <div data-udraw="zoom_container">
                            ...
                            <div>
                                ...
                                <a href="#" class="text_buttons" data-bs-toggle="dropdown" data-udraw="zoom_text_btn"><span data-udraw="zoom_text"></span></a>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button class="close button" data-bs-dismiss="modal">×</button>
                ...
                <!-- Crop Dialog -->
                <div class="modal overlay-modal" id="crop-modal" data-udraw="cropModal" data-bs-backdrop="static" data-bs-keyboard="false">
                ...
                <div class="modal overlay-modal" id="replace-image-modal" data-udraw="replaceImageModal" data-bs-backdrop="static" data-bs-keyboard="false">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-body">
                ...
                <div class="modal overlay-modal" data-udraw="multipagePDFModal" data-bs-backdrop="static" data-bs-keyboard="false">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                ...
                <!-- Load XML modal -->
                <div class="modal overlay-modal" data-udraw="load_xml_modal" data-bs-backdrop="static" data-bs-keyboard="false">
                    <div class="modal-dialog">
                        <div class="modal-content">
                ...
                <!--Choose route dialog-->
                <div class="modal overlay-modal" data-udraw="choose_modal" data-bs-backdrop="static" data-bs-keyboard="false">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-body" style="text-align: center;">
