...
<div id="udraw-main-designer-ui" style="height: 96%; position: relative; padding: 25px; overflow: auto;">
                ...
                <div class="col menu_item">
                    <form class="cart" method="post" enctype="multipart/form-data">
                        ...
                        <div class="quantity_box">
                            ...
                            <span><?php echo uDrawUtil::esc_string($product->get_price()); ?></span>
                        </div>
    ...
    <div class="object_tools hidden" data-object_type="text">
        ...
        <div class="row">
            ...
            <div class="col-4 col-md-2 menu_item">
                <input type="text" readonly value="#000000" data-opacity="1" data-udraw="designerColourPicker" class="colourwheel" style="background: url('<?php echo uDrawUtil::esc_string(UDRAW_DESIGNER_IMG_PATH); ?>colourwheel.png') no-repeat; background-size: contain;">
            </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <a href="#" data-bs-dismiss="modal" style="float: right;"><i class="fas fa-times"></i></a>
                </div>
                    ...
                    <div>
                        <ul class="objects_menu">
                            ...
                            <li role="presentation" data-udraw="addCurvedText">
                                <img src="<?php echo uDrawUtil::esc_string(UDRAW_DESIGNER_IMG_PATH); ?>arc-text-black.png" />
                ...
                <div class="modal-body">
                    <ul class="objects_menu">
                        <li role="presentation" data-udraw="addCircle">
                            <img src="<?php echo uDrawUtil::esc_string(UDRAW_DESIGNER_IMG_PATH); ?>circle-icon.png" class="icon" />
                            <span data-i18n="[html]menu_label.circle-shape"></span>
                        </li>
                        <li role="presentation" data-udraw="addRectangle">
                            <img src="<?php echo uDrawUtil::esc_string(UDRAW_DESIGNER_IMG_PATH); ?>square-icon.png" class="icon" />
                            <span data-i18n="[html]menu_label.rect-shape"></span>
                        </li>
                        <li role="presentation" data-udraw="addTriangle">
                            <img src="<?php echo uDrawUtil::esc_string(UDRAW_DESIGNER_IMG_PATH); ?>triangle-icon.png" class="icon" />
                            <span data-i18n="[html]menu_label.triangle-shape"></span>
                        </li>
                        <li role="presentation" data-udraw="addLine">
                            <img src="<?php echo uDrawUtil::esc_string(UDRAW_DESIGNER_IMG_PATH); ?>line-icon.png" class="icon" />
                            <span data-i18n="[html]menu_label.line-shape"></span>
                        </li>
                        <li role="presentation" data-udraw="addCurvedLine">
                            <img src="<?php echo uDrawUtil::esc_string(UDRAW_DESIGNER_IMG_PATH); ?>curved-line-icon.png" class="icon" />
                            <span data-i18n="[html]menu_label.curved-line-shape"></span>
                        </li>
                        <li role="presentation" data-udraw="addStar">
                            <img src="<?php echo uDrawUtil::esc_string(UDRAW_DESIGNER_IMG_PATH); ?>star-icon.png" class="icon" />
