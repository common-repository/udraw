        ...
        <div id="udraw-main-designer-ui">
            <div id="designer-menu" data-udraw="designerMenu">
                ...
                <div class="btn-groups center">
                    <div class="group">
                        <button class="group-btn" data-udraw="duplicateButton" type="button" data-bs-toggle="tooltip" title="Duplicate">
                            <i class="far fa-copy"></i>
                        </button>
                        <button class="group-btn" data-udraw="pasteButton" type="button" data-bs-toggle="tooltip" title="Paste">
                            <i class="fas fa-paste"></i>
                        </button>
                        <button class="group-btn" data-udraw="removeButton" type="button" data-bs-toggle="tooltip" title="Delete">
                            <i class="far fa-trash-alt"></i>
                        </button>
                    </div>
                    <div class="group">
                        <button class="group-btn" data-udraw="undoButton" type="button" data-bs-toggle="tooltip" title="Undo">
                            <i class="fas fa-undo-alt"></i>
                        </button>
                        <button class="group-btn" data-udraw="redoButton" type="button" data-bs-toggle="tooltip" title="Redo">
                            <i class="fas fa-redo-alt"></i>
                        </button>
                    </div>
                    <div class="group">
                        <button class="group-btn" data-udraw="increaseZoomButton" type="button" data-bs-toggle="tooltip" title="Zoom In">
                            <i class="fas fa-search-plus"></i>
                        </button>
                        <button class="group-btn" data-udraw="decreaseZoomButton" type="button" data-bs-toggle="tooltip" title="Zoom Out">
                            <i class="fas fa-search-minus"></i>
                        </button>
                    </div>
                    <div class="group">
                        <button class="group-btn" data-udraw="displayLayers" type="button" data-bs-toggle="tooltip" title="Display Layers">
                            <i class="fas fa-layer-group"></i>
                        </button>
                        <button class="group-btn" data-udraw="clearCanvas" type="button" data-bs-toggle="tooltip" title="Clear All Objects">
                ...
                <!-- If Display Options First is enabled-->
                        ...
                        <button class="group-btn" id="show-udraw-display-options-ui-btn" type="button">
                            ...
                            <?php } ?>
                            <?php if ($product_type == "simple" && $displayInlineAddToCart) { ?>
                        ...
                        <?php if (!$displayOptionsFirst && !isset($displayPriceMatrixOptions)) { ?>
                            ...
                            <form class="cart" method="post" enctype="multipart/form-data" style="display: inline-block; float: right;">
                                ...
                                <?php if ($displayInlineAddToCart) {?>
                                    ...
                                    <input type="hidden" name="add-to-cart" value="<?php echo uDrawUtil::esc_string( $product_id ); ?>"> 
                                    <span style="font-size:1.5em; vertical-align:middle;"><?php echo get_woocommerce_currency_symbol(); ?></span><span id="product_total_price" style="font-size:1.5em; vertical-align:middle;"><?php echo uDrawUtil::esc_string($product->get_price()); ?></span>
                    ...
                    <div class="tools_container shapes">
                        <ul>
                            <li id="Circle-list-container">
                                <a href="#" id="shapes-circle-add-btn" data-udraw="addCircle" data-bs-toggle="tooltip" data-i18n="[title]menu_label.circle">
                                    <i class="fas fa-circle fa-4x shape-icon"></i> 
                                </a>
                            </li>
                            <li id="Rectangle-list-container">
                                <a href="#" id="shapes-sqaure-add-btn" data-udraw="addRectangle" data-bs-toggle="tooltip" data-i18n="[title]menu_label.rect">
                                    <i class="fas fa-square fa-4x shape-icon"></i> 
                                </a>
                            </li>
                            <li id="Triangle-list-container">
                                <a href="#" id="shapes-triangle-add-btn" data-udraw="addTriangle" data-bs-toggle="tooltip" data-i18n="[title]menu_label.triangle">
                                    <i class="fas fa-play fa-4x shape-icon"></i>
                                </a>
                            </li>
                            <li id="Line-list-container">
                                <a href="#" id="shapes-line-add-btn" data-udraw="addLine" data-bs-toggle="tooltip" data-i18n="[title]menu_label.line">
                                    <i class="fas fa-grip-lines-vertical fa-4x shape-icon"></i> 
                                </a>
                            </li>
                            <li id="Curved-line-list-container">
                                <a href="#" id="shapes-curved-line-add-btn" data-udraw="addCurvedLine" data-bs-toggle="tooltip" data-i18n="[title]menu_label.curved_line">
                                    <i class="fas fa-bezier-curve fa-4x shape-icon"></i> 
                                </a>
                            </li>
                            <li id="Polygon-list-container">
                                <a href="#" id="open-polyshape-modal-btn" data-udraw="addPolygon" data-bs-toggle="tooltip" data-i18n="[title]menu_label.polyshape">
                                    <i class="fas fa-draw-polygon fa-4x shape-icon"></i>
                                </a>
                            </li>
                            <li id="Star-list-container">
                                <a href="#" id="shapes-star-add-btn" data-udraw="addStar" data-bs-toggle="tooltip" data-i18n="[title]menu_label.star">
                ...
                <div id="canvas-container" data-udraw="canvasContainer">
                    <div id="racad-designer" data-udraw="canvasWrapper">
                        <div class="alert alert-danger fade in" role="alert" id="racad-designer-object-outside-alert" style="display:none;padding: 5px;" data-udraw="outsideAlert">
                            <button type="button" class="close" data-bs-dismiss="alert"><span aria-hidden="true" data-i18n="[html]text.objects-outside-dismiss"></span><span class="sr-only">Close</span></button>
                            ...
                            <div class="panel-body designer-panel-body" style="padding:5px;">
                                ...
                                <div style="display:none;" data-udraw="curvedTextContainer" class="group curvedText">
                                    ...
                                    <div style="padding: 5px;">
                                        <div style="width: 30%; display:inline-block;" data-bs-toggle="tooltip-top" 
                                    ...
                                    <div style="padding: 5px;">
                                        ...
                                        <a href="#" class="btn btn-default designer-toolbar-btn" data-bs-toggle="tooltip-top" 
                                ...
                                <div class="alignContainer objTool" data-udraw="objectAlignContainer">
                                    ...
                                    <a href="#" data-udraw="objectsAlignLeft">
                                        <div class="innerAnchorDiv"><img src="<?php echo uDrawUtil::esc_string(UDRAW_DESIGNER_IMG_PATH) ?>bg_btn_align_left.png" alt="Align Left" /></div>
                                    </a>
                                    <a href="#" data-udraw="objectsAlignCenter">
                                        <div class="innerAnchorDiv"><img src="<?php echo uDrawUtil::esc_string(UDRAW_DESIGNER_IMG_PATH) ?>bg_btn_align_center.png" alt="Align Center" /></div>
                                    </a>
                                    <a href="#" data-udraw="objectsAlignRight">
                                        <div class="innerAnchorDiv"><img src="<?php echo uDrawUtil::esc_string(UDRAW_DESIGNER_IMG_PATH) ?>bg_btn_align_right.png" alt="Align Right" /></div>
                                    </a>
                                    <a href="#" data-udraw="objectsAlignTop">
                                        <div class="innerAnchorDiv"><img src="<?php echo uDrawUtil::esc_string(UDRAW_DESIGNER_IMG_PATH) ?>bg_btn_align_top.png" alt="Align Top" /></div>
                                    </a>
                                    <a href="#" data-udraw="objectsAlignMiddle">
                                        <div class="innerAnchorDiv"><img src="<?php echo uDrawUtil::esc_string(UDRAW_DESIGNER_IMG_PATH) ?>bg_btn_align_middle.png" alt="Align Middle" /></div>
                                    </a>
                                    <a href="#" data-udraw="objectsAlignBottom">
                                        <div class="innerAnchorDiv"><img src="<?php echo uDrawUtil::esc_string(UDRAW_DESIGNER_IMG_PATH) ?>bg_btn_align_bottom.png" alt="Align Bottom" /></div>
                                    </a>
                                </div>
                ...
                <div class="modal-dialog" style="width:1000px;">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <a href="#" class="btn btn-danger" data-bs-dismiss="modal"><span data-i18n="[html]common_label.close"></span></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal" id="qrcode-modal" data-udraw="qrModal">
                <div class="modal-dialog modal-md" style="width: 600px;">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <a href="#" class="btn btn-danger" data-bs-dismiss="modal"><span data-i18n="[html]common_label.cancel"></span></a>
            ...
            <!-- Crop Dialog -->
            <div class="modal" id="crop-modal" data-udraw="cropModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1">
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <a href="#" class="btn btn-danger" data-bs-dismiss="modal" data-udraw="crop_cancel"><span data-i18n="[html]button_label.cancel_crop"></span></a>
...
<form method="POST" action="" name="udraw_save_later_form" id="udraw_save_later">
    ...
    <input type="hidden" name="udraw_save_post_id" value="<?php echo uDrawUtil::esc_string($post->ID) ?>" />
    <input type="hidden" name="udraw_price_matrix_selected_by_user" value="" />
    <input type="hidden" name="udraw_save_access_key" value="<?php echo (isset($_GET['udraw_access_key'])) ? uDrawUtil::esc_string($_GET['udraw_access_key']) : NULL; ?>" />
...
<style type="text/css">
    <?php echo stripcslashes(htmlspecialchars_decode(uDrawUtil::esc_js($_udraw_settings['udraw_designer_css_hook']))); ?>
</style>
    ...
    jQuery(document).ready(function () {
        jQuery(document).on('udraw-loaded', function(){
            ...
            if(productURL.indexOf('udraw_access_key') !== -1) {
                ...
                var storage = '<?php echo uDrawUtil::esc_string(UDRAW_STORAGE_URL) ?>';
                var username = '<?php echo uDrawUtil::esc_string($loggedInUser) ?>';
                if (username !== '') {
        ...
        <?php echo stripcslashes(htmlspecialchars_decode(uDrawUtil::esc_js($_udraw_settings['udraw_designer_js_hook']))); ?>
