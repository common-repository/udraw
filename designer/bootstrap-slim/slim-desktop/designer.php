                        ...
                        <div data-udraw="top_toolbar" class="top_toolbar">
                            <div class="text_tools toolset tools" style="display: none;">
                                ...
                                <div class="group">
                                    ...
                                    <div class="group-element" data-udraw="spacing_row">
                                        <button class="group-btn" data-bs-toggle="dropdown" data-i18n="[title]tooltip.letter-spacing">
                                ...
                                <div class="group">
                                    ...
                                    <div class="group-element" data-udrae="objectColour">
                                        <div data-udraw="designerColourContainer" style="inline-block">
                                            <button class="group-btn" data-bs-toggle="dropdown" data-i18n="[title]tooltip.object-colour">
                            ...
                            <div class="image_tools toolset tools" style="display: none">
                                ...
                                <div class="group">
                                    <div class="group-element" data-udraw="rotateContainer">       
                                        <button class="group-btn" data-bs-toggle="dropdown" data-i18n="[title]tooltip.rotate">
                                            <i class="fas fa-undo-alt"></i>
                                        </button>
                            ...
                            <div class="shapes_tools toolset tools" style="display: none">
                                <div class="group">
                                    <div class="group-element" data-udraw="fillContainer">   
                                        <button class="group-btn" data-bs-toggle="dropdown" data-i18n="[title]text_label.object-fill">
                                            Fill
                                        </button>
                            ...
                            <div class="group tools">
                                <div class="group-element" data-udraw="opacityContainer">
                                    <button class="group-btn" data-bs-toggle="dropdown" data-i18n="[title]text.opacity-level">
                                ...
                                <div class="group-element" data-udraw="objectOptionsContainer">
                                    <button class="group-btn" data-bs-toggle="dropdown">
                                ...
                                <div class="group-element" data-udraw="objectAlignContainer" data-i18n="[title]tooltip.object_align">
                                    ...
                                    <div data-udraw="object_align_container" class="dropdown-menu">
                                        <a href="#" data-udraw="objectsAlignLeft">
                                            <div class="innerAnchorDiv"><img src="<?php echo uDrawUtil::esc_string(UDRAW_DESIGNER_IMG_PATH) ?>bg_btn_align_left.png" alt="Align Left" /><span> Align Left</span></div>
                                        </a>
                                        <a href="#" data-udraw="objectsAlignCenter">
                                            <div class="innerAnchorDiv"><img src="<?php echo uDrawUtil::esc_string(UDRAW_DESIGNER_IMG_PATH) ?>bg_btn_align_center.png" alt="Align Center" /><span> Align Center</span></div>
                                        </a>
                                        <a href="#" data-udraw="objectsAlignRight">
                                            <div class="innerAnchorDiv"><img src="<?php echo uDrawUtil::esc_string(UDRAW_DESIGNER_IMG_PATH) ?>bg_btn_align_right.png" alt="Align Right" /><span> Align Right</span></div>
                                        </a>
                                        <a href="#" data-udraw="objectsAlignTop">
                                            <div class="innerAnchorDiv"><img src="<?php echo uDrawUtil::esc_string(UDRAW_DESIGNER_IMG_PATH) ?>bg_btn_align_top.png" alt="Align Top" /><span> Align Top</span></div>
                                        </a>
                                        <a href="#" data-udraw="objectsAlignMiddle">
                                            <div class="innerAnchorDiv"><img src="<?php echo uDrawUtil::esc_string(UDRAW_DESIGNER_IMG_PATH) ?>bg_btn_align_middle.png" alt="Align Middle" /><span> Align Middle</span></div>
                                        </a>
                                        <a href="#" data-udraw="objectsAlignBottom">
                                            <div class="innerAnchorDiv"><img src="<?php echo uDrawUtil::esc_string(UDRAW_DESIGNER_IMG_PATH) ?>bg_btn_align_bottom.png" alt="Align Bottom" /><span> Align Bottom</span></div>
                                        </a>
                                    </div>
                                </div>
                            </div>
