...
<div class="multi_template_container">
    ...
    <div id="multi_template_display" class="row" style="margin-top: 15px;" >
        ...
        <div class="col-md-3 template_display_item">
            <a href="#" class="udraw_multitemplate" data-template-name="<?php echo uDrawUtil::esc_string($template->name); ?>" data-template-id="<?php echo uDrawUtil::esc_string($template->id); ?>" onclick="displayDesigner('<?= $template->design ?>')">
                <img style="max-width:300px" src="<?= $template->preview ?>"/>
                <p class="template_name"><?php echo uDrawUtil::esc_string($template->name); ?></p>
            </a>
        </div>
        <?php } ?>
    </div>
