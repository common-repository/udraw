...
$valid_extensions = ".jpg,.jpeg,.png,.gif,.pdf,.tif,.tiff";
...
$target_dpi = $_udraw_settings['udraw_price_matrix_upload_min_dpi'];
...
<script>
    var allowUploadArtwork = '<?php echo uDrawUtil::esc_string($allowUploadArtwork) ?>';
