...
<div class="wrap">
        ...
        if (isset($_POST['save_udraw_settings']) ) {
            ...
            if (isset($_GET['tab']) && $_GET['tab'] == "goepower") { 
                ...
                if (!$isGoepowerValid) {
                    ...
                    if (strlen($goepower_login->Token) === 0) {
                        echo '<div id="setting-error-settings_updated" class="error settings-error"><p><strong>GoEpower Auth Error: '. uDrawUtil::esc_string($goepower_login->ErrorMessage) .'</strong></p></div>';
            ...
            if (isset($_GET['tab']) && $_GET['tab'] == "social_media") {
                if (isset($_POST['designer_enable_facebook_functions'])) {
                    ...
                    $udrawSettings->update_setting('designer_facebook_app_id', uDrawUtil::sanitize_variables($_POST['designer_facebook_app_id']));
                } else {
                ...
                if (isset($_POST['designer_enable_instagram_functions'])) {
                    ...
                    $udrawSettings->update_setting('designer_instagram_client_id', uDrawUtil::sanitize_variables($_POST['designer_instagram_client_id']));
                } else {
                ...
                if (isset($_POST['designer_enable_flickr_functions'])) {
                    ...
                    $udrawSettings->update_setting('designer_flickr_client_id', uDrawUtil::sanitize_variables($_POST['designer_flickr_client_id']));
                    $udrawSettings->update_setting('designer_flickr_secret_id', uDrawUtil::sanitize_variables($_POST['designer_flickr_secret_id']));
                } else {
                    //Disable Instagram photos automatically if this is disabled
                ...
                if (isset($_POST['designer_enable_google_functions'])) {
                    ...
                    $udrawSettings->update_setting('designer_google_api_key', uDrawUtil::sanitize_variables($_POST['designer_google_api_key']));
                    $udrawSettings->update_setting('designer_google_client_id', uDrawUtil::sanitize_variables($_POST['designer_google_client_id']));
                } else {
    ...
    <?php
        $current_tab = 'general';
        if (isset($_GET['tab'])) {
            $current_tab = uDrawUtil::sanitize_variables($_GET['tab']);
        }
    ?>
            ...
            <div class="icon32 icon32-woocommerce-status" id="icon-woocommerce"><br /></div><h2 class="nav-tab-wrapper woo-nav-tab-wrapper">
                <?php
                    ...
                    foreach ( $tabs as $name => $label ) {
                        echo '<a href="' . admin_url( 'admin.php?page=edit_udraw_settings&tab=' . uDrawUtil::esc_string($name) ) . '" class="nav-tab ';
                        ...
                        echo '>' . uDrawUtil::esc_string($label) . '</a>';
                    }
                ?>
            </h2><br/>
            <?php
        ...
        <table class="form-table">
            <tbody> 
                ...
                <tr valign="top" class="">
                    ...
                    <td class="forminp forminp-checkbox">
                        <fieldset>
                            <textarea name="udraw_general_css_hook" id="udraw_general_css_hook" rows="7" cols="100" style="display:none;"><?php echo (htmlspecialchars($_udraw_settings['udraw_general_css_hook'], ENT_NOQUOTES)); ?></textarea>
                ...
                <tr valign="top" class="">
                    ...
                    <td class="forminp forminp-checkbox">
                        <fieldset>
                            <textarea name="udraw_general_js_hook" id="udraw_general_js_hook" rows="7" cols="100" style="display:none;"><?php echo (htmlspecialchars($_udraw_settings['udraw_general_js_hook'], ENT_NOQUOTES)); ?></textarea>
                ...
                <tbody>
                            ...
                            <select name="designer_skin" style="min-width: 300px; display: none;" class="chosen-udraw" id="designer_skin">
                                <?php
                                    ...
                                    foreach ( $skins as $value => $name ) {
                                        ...
                                        echo "<option class=\"level-0\" value=\"" . uDrawUtil::esc_string($value) . "\" ". uDrawUtil::esc_string($selected) .">". uDrawUtil::esc_string($name) ."</option>";
                                    }    
                                ?>                        
                            </select>
                            ...
                            <select name="udraw_designer_language" style="min-width: 300px; display: none;" class="chosen-udraw" id="udraw_designer_language">
                                <?php
                                    ...
                                    foreach ($availableLanguages as $thisLanguage) {
                                        ...
                                        $file_url = (file_exists(UDRAW_LANGUAGES_URL.'udraw-'.$thisLanguage.'.txt')) ? UDRAW_LANGUAGES_URL.'udraw-'.$thisLanguage.'.txt' : UDRAW_PLUGIN_URL.'/designer/includes/locales/udraw-'.$thisLanguage.'.txt';
                                        $fileContents = json_decode(remove_utf8_bom($uDrawUtil->get_web_contents($file_url)));
                    ...
                    <tr valign="top">
                        ...
                        <td class="forminp forminp-text">
                                <input name="udraw_designer_global_template_key" id="udraw_designer_global_template_key" type="text" style="width: 350px;" value="<?php echo uDrawUtil::esc_string($_udraw_settings['udraw_designer_global_template_key']); ?>" class="">
                ...
                <tbody>
                    <tr valign="top">
                        ...
                        <td class="forminp forminp-text">
                            ...
                            ?>
                            <input type="checkbox" name="designer_impose_bleed" id="designer_impose_bleed" <?php echo uDrawUtil::esc_string($checked) ?> >
                    ...
                    <tr valign="top" style="<?php echo $bleed_adj_display ?>" class="designer_bleed_row">
                        ...
                        <td class="forminp forminp-text">
                            <input type="number" name="designer_bleed" id="designer_bleed" value="<?php echo uDrawUtil::esc_string($_udraw_settings['designer_bleed']) ?>" min="0" step="any" >
                    ...
                    <tr valign="top" class="">
                        ...
                        <td class="forminp forminp-checkbox">
                            <fieldset>
                                ...
                                <input name="udraw_design_page_names" id="udraw_design_page_names" type="text" style="width: 350px;" value="<?php echo uDrawUtil::esc_string($_udraw_settings['udraw_design_page_names']); ?>" class=""><br />
                    ...
                    <tr valign="top" class="">
                        ...
                        <td class="forminp forminp-checkbox">
                            <fieldset>
                                ...
                                <textarea name="udraw_production_png_color_replacement" id="udraw_production_png_color_replacement" style="width: 350px;" value="<?php echo uDrawUtil::esc_string($_udraw_settings['udraw_production_png_color_replacement']); ?>" class=""><?php echo uDrawUtil::esc_string($_udraw_settings['udraw_production_png_color_replacement']); ?></textarea><br />
                    ...
                    <tr valign="top" class="">
                        ...
                        <td class="forminp forminp-checkbox">
                            <fieldset>
                                ...
                                <input name="udraw_order_document_format" id="udraw_order_document_format" type="text" style="width: 350px;" value="<?php echo uDrawUtil::esc_string($_udraw_settings['udraw_order_document_format']); ?>" class=""><br />
                    ...
                    <tr valign="top" class="">
                        ...
                        <td class="forminp forminp-checkbox">
                            <fieldset>
                                ...
                                ?>
                                <input type="checkbox" id="designer_enable_flickr_photos" name="designer_enable_flickr_photos" value="true" <?php echo uDrawUtil::esc_string($checked) ?>/>
                    ...
                    <tr valign="top" class="">
                        ...
                        <td class="forminp forminp-checkbox">
                            <fieldset>
                                ...
                                <br>
                                <input type="number" min="1" step="1" name="designer_minimum_dpi" value="<?php echo uDrawUtil::esc_string($_udraw_settings['designer_minimum_dpi']) ?>" <?php if (!$dpi_enabled) { ?> style="display: none;" <?php } ?> >
                            </fieldset>
                        </td>
                    </tr>
                    ...
                    <tr valign="top" class="">
                        ...
                        <td class="forminp forminp-checkbox">
                            <fieldset>
                                ...
                                <input name="udraw_custom_duration_days" id="udraw_custom_duration_days" type="number" max="90" style="width: 350px;" value="<?php echo uDrawUtil::esc_string($_udraw_settings['udraw_custom_duration_days']); ?>" class=""><br />
        ...
        <table class="form-table">
            <tbody>
                <tr valign="top" class="">
                    ...
                    <td class="forminp forminp-checkbox">
                        <fieldset>
                            <textarea name="udraw_designer_css_hook" rows="7" cols="100" id="udraw_designer_css_hook" style="display:none;"><?php echo (htmlspecialchars($_udraw_settings['udraw_designer_css_hook'], ENT_NOQUOTES)); ?></textarea>
                            <legend class="screen-reader-text"><span><?php _e('Custom CSS Hook', 'udraw') ?></span></legend>
                ...
                <tr valign="top" class="">
                    ...
                    <td class="forminp forminp-checkbox">
                        <fieldset>
                            <textarea name="udraw_designer_js_hook" rows="7" cols="100" id="udraw_designer_js_hook" style="display:none;"><?php echo (htmlspecialchars($_udraw_settings['udraw_designer_js_hook'], ENT_NOQUOTES)); ?></textarea>
                            <legend class="screen-reader-text"><span><?php _e('Custom JS Hook', 'udraw') ?></span></legend>
                            ...
                            <?php
                                foreach ($pages as $page) {
                                    if ($page->ID == $_udraw_settings['udraw_private_template_page_id']) {
                                        echo "<option class=\"level-0\" value=\"". uDrawUtil::esc_string($page->ID) ."\" selected>". uDrawUtil::esc_string($page->post_title) ."</option>";
                                    } else {
                                        echo "<option class=\"level-0\" value=\"". uDrawUtil::esc_string($page->ID) ."\">". uDrawUtil::esc_string($page->post_title) ."</option>";
                                    }                                    
                                }
                            ?>
                        </select>
...
function udraw_social_media_settings_html($_udraw_settings) {
            ...
            <tr valign="top" class="facebook-app-input" style="display: none;">
                ...
                <td class="forminp forminp-checkbox">
                    <fieldset>
                        ...
                        <?php
                        if ($_udraw_settings['designer_enable_facebook_functions']) {
                            ?><input type="text" id="designer_facebook_app_id" name="designer_facebook_app_id" value="<?php echo uDrawUtil::esc_string($_udraw_settings['designer_facebook_app_id']) ?>"/>
                            <?php
                        } else {
            ...
            <tr valign="top" class="instagram-app-input" style="display: none;">
                ...
                <td class="forminp forminp-checkbox">
                    <fieldset>
                        ...
                        <?php
                        if ($_udraw_settings['designer_enable_instagram_functions']) {
                            ?><input type="text" id="designer_instagram_client_id" name="designer_instagram_client_id" value="<?php echo uDrawUtil::esc_string($_udraw_settings['designer_instagram_client_id']) ?>"/>
                            <?php
                        } else {
            ...
            <!--<tr valign="top" class="">
                ...
                <td class="forminp forminp-checkbox">
                    <fieldset>
                        ...
                        ?>
                        <input type="checkbox" id="designer_enable_flickr_functions" name="designer_enable_flickr_functions" value="true" <?php echo uDrawUtil::esc_string($checked) ?>/>
            ...
            <tr valign="top" class="flickr-app-input" style="display: none;">
                ...
                <td class="forminp forminp-checkbox">
                    <fieldset>
                        ...
                        <label>
                            <input type="text" id="designer_flickr_client_id" name="designer_flickr_client_id" value="<?php echo uDrawUtil::esc_string($_udraw_settings['designer_flickr_client_id']) ?>"/>
                        </label>
                    </fieldset>
                </td>
            </tr>
            <tr valign="top" class="flickr-app-input" style="display: none;">
                ...
                <td class="forminp forminp-checkbox">
                    <fieldset>
                        ...
                        <label>
                            <input type="password" id="designer_flickr_secret_id" name="designer_flickr_secret_id" value="<?php echo uDrawUtil::esc_string($_udraw_settings['designer_flickr_secret_id']) ?>"/>
                        </label>
                    </fieldset>
                </td>
            </tr>-->
            ...
            <tr valign="top" class="">
                ...
                <td class="forminp forminp-checkbox">
                    <fieldset>
                        ...
                        ?>
                        <input type="checkbox" id="designer_enable_google_functions" name="designer_enable_google_functions" value="true" <?php echo uDrawUtil::esc_string($checked) ?>/>
            ...
            <tr valign="top" class="google-app-input" style="display: none;">
                ...
                <td class="forminp forminp-checkbox">
                    <fieldset>
                        ...
                        <label>
                            <input type="text" id="designer_google_api_key" name="designer_google_api_key" value="<?php echo uDrawUtil::esc_string($_udraw_settings['designer_google_api_key']) ?>"/>
                        </label>
                    </fieldset>
                </td>
            </tr>
            <tr valign="top" class="google-app-input" style="display: none;">
                ...
                <td class="forminp forminp-checkbox">
                    <fieldset>
                        ...
                        <label>
                            <input type="text" id="designer_google_client_id" name="designer_google_client_id" value="<?php echo uDrawUtil::esc_string($_udraw_settings['designer_google_client_id']) ?>"/>
                        </label>
                    </fieldset>
                </td>
            </tr>
    ...
    <div>
        ...
        <p>
            <img src="<?php echo uDrawUtil::esc_string(UDRAW_PLUGIN_URL) ?>/assets/includes/social-media/facebook.gif" style="max-width: 500px; cursor: pointer;" onclick="javascript: window.open('<?php echo uDrawUtil::esc_string(UDRAW_PLUGIN_URL) ?>/assets/includes/social-media/facebook.gif', '_blank'); " title="<?php _e('Click to open in new tab', 'udraw'); ?>"/> 
        </p>
        <p class="description">
        ...
        <p>
            <img src="<?php echo uDrawUtil::esc_string(UDRAW_PLUGIN_URL) ?>/assets/includes/social-media/fb-user_photos.gif" style="max-width: 500px; cursor: pointer;" onclick="javascript: window.open('<?php echo uDrawUtil::esc_string(UDRAW_PLUGIN_URL) ?>/assets/includes/social-media/fb-user_photos.gif', '_blank'); " title="<?php _e('Click to open in new tab', 'udraw'); ?>"/> 
        </p>
        <p class="description">
        ...
        <p>
            <img src="<?php echo uDrawUtil::esc_string(UDRAW_PLUGIN_URL) ?>/assets/includes/social-media/instagram.gif" style="max-width: 500px; cursor: pointer;" onclick="javascript: window.open('<?php echo uDrawUtil::esc_string(UDRAW_PLUGIN_URL) ?>/assets/includes/social-media/instagram.gif', '_blank'); " title="<?php _e('Click to open in new tab', 'udraw'); ?>"/> 
        </p>
        <br>
        <p class="description" style="font-weight: bold;">
        ...
        <p>
            <img src="<?php echo uDrawUtil::esc_string(UDRAW_PLUGIN_URL) ?>/assets/includes/social-media/google-api.gif" style="max-width: 500px; cursor: pointer;" onclick="javascript: window.open('<?php echo uDrawUtil::esc_string(UDRAW_PLUGIN_URL) ?>/assets/includes/social-media/google-api.gif', '_blank'); " title="<?php _e('Click to open in new tab', 'udraw'); ?>"/> 
        </p>
    </div>
    <?php
}
...
function udraw_price_matrix_settings_html ($_udraw_settings) {
    ...
    <table class="form-table">
        ...
        <tr valign="top">
                ...
                <td class="forminp forminp-checkbox">
                    <select name="udraw_price_matrix_allowed_file_types[]" id="udraw_price_matrix_allowed_file_types"  multiple="multiple">
                        <?php
                        $allowedExt = array (
                        ...
                        $validExt = $_udraw_settings['udraw_price_matrix_allowed_file_types'];
                        ...
                        foreach ($allowedExt as $aKey => $aValue) {
                            ...
                            if ($found_selected) {
                                echo '<option value="'. uDrawUtil::esc_string($aKey) .':'. uDrawUtil::esc_string($aValue) .'" selected>'. uDrawUtil::esc_string($aKey) .'</option>';
                            } else {
                                echo '<option value="'. uDrawUtil::esc_string($aKey) .':'. uDrawUtil::esc_string($aValue) .'">'. uDrawUtil::esc_string($aKey) .'</option>';
                            }
                        }
                        ?>
                    </select>
            ...
            <tr valign="top">
                ...
                <td class="forminp forminp-text">
                    <input name="udraw_price_matrix_upload_min_dpi" id="udraw_price_matrix_upload_min_dpi" type="text" style="width: 350px;" value="<?php echo uDrawUtil::esc_string($_udraw_settings['udraw_price_matrix_upload_min_dpi']); ?>" class="">
            ...
            <tr valign="top" class="">
                ...
                <td class="forminp forminp-checkbox">
                    <fieldset>
                        ...
                        <form action="">
                            <input type="radio" name="price_matrix_placement" value="default" <?php echo uDrawUtil::esc_string($is_default) ?>><?php _e('Default (in Product Summary)', 'udraw') ?></br>
                            <input type="radio" name="price_matrix_placement" value="custom" <?php echo uDrawUtil::esc_string($is_custom) ?> ><?php _e('Custom Placement (please specify)', 'udraw') ?>&nbsp;<input type="text" value="<?php echo uDrawUtil::esc_string($_udraw_settings['udraw_price_matrix_placement']) ?>" name="price_matrix_placement_input">
                        </form>
                    </fieldset>
                </td>
            </tr>
            ...
            <tr valign="top">
                ...
                <td class="forminp forminp-text">
                    <input name="price_matrix_settings_placement" id="price_matrix_settings_placement" type="text" style="width: 350px;" value="<?php echo uDrawUtil::esc_string($_udraw_settings['udraw_price_matrix_settings_placement']); ?>" class="">
            ...
            <tr valign="top" class="">
                ...
                <td class="forminp forminp-checkbox">
                    <fieldset>
                        <textarea name="udraw_price_matrix_css_hook" id="udraw_price_matrix_css_hook" rows="7" cols="100" style="display:none;"><?php echo (htmlspecialchars($_udraw_settings['udraw_price_matrix_css_hook'], ENT_NOQUOTES)); ?></textarea>
                        <legend class="screen-reader-text"><span><?php _e('Custom CSS Hook', 'udraw') ?></span></legend>
            ...
            <tr valign="top" class="">
                ...
                <td class="forminp forminp-checkbox">
                    <fieldset>
                        <textarea name="udraw_price_matrix_js_hook" id="udraw_price_matrix_js_hook" rows="7" cols="100" style="display:none;"><?php echo (htmlspecialchars($_udraw_settings['udraw_price_matrix_js_hook'], ENT_NOQUOTES)); ?></textarea>
                        <legend class="screen-reader-text"><span><?php _e('Custom JS Hook', 'udraw') ?></span></legend>
    ...
    <table class="form-table">
        <tbody>   
            <tr valign="top">
                ...
                <td class="forminp forminp-text">
                    <input name="gosendex_api_key" id="gosendex_api_key" type="text" style="width: 350px;" value="<?php echo uDrawUtil::esc_string($_udraw_settings['gosendex_api_key']); ?>" class="">
                </td>
            </tr>
            <?php
                if (strlen($_udraw_settings['gosendex_api_key']) > 1) {
                    ...
                    <tr valign="top" class="">
                        <th scope="row" class="titledesc"><?php _e('Group Order Files', 'udraw') ?></th>
                        <td class="forminp forminp-checkbox">
                            <fieldset>
                                <legend class="screen-reader-text"><span><?php _e('Group Order Files', 'udraw') ?></span></legend>
                                <label for="gosendex_send_file_after_order">
                                    <?php if ($_udraw_settings['gosendex_group_order_files']) { ?>
                                        <input type="checkbox" name="gosendex_group_order_files" value="true" checked="checked"/> <?php
                                    } else { ?>
                                        <input type="checkbox" name="gosendex_group_order_files" value="false" /> <?php
                                    } ?>
                                    <?php _e('By default all order files are uploaded into sub folders seperated by order line id. If enabled, all order files will be uploaded to GoSendEx into one single folder.', 'udraw') ?></label>
                            </fieldset>
                        </td>
                    </tr>
                    <tr valign="top" class="">
                        ...
                        <td class="forminp forminp-checkbox">
                            <fieldset>
                                ...
                                <?php if ($_udraw_settings['gosendex_send_email_after_order_sent']) { ?>
                    ...
                    <tr valign="top">
                        ...
                        <td class="forminp forminp-text">
                            <input name="gosendex_domain" id="gosendex_domain" type="text" style="width: 350px;" value="<?php echo uDrawUtil::esc_string($_udraw_settings['gosendex_domain']); ?>" class="">
                    ...
                    <tr valign="top">
                        ...
                        <td class="forminp forminp-text">
                            <input name="gosendex_email_to_send_notification" id="gosendex_email_to_send_notification" type="text" style="width: 350px;" value="<?php echo uDrawUtil::esc_string($_udraw_settings['gosendex_email_to_send_notification']); ?>" class="">
...
function udraw_goepower_settings_html($_udraw_settings) {
    ...
    <table class="form-table">
        <tbody> 
            <tr valign="top">
                ...
                <td class="forminp forminp-text">
                    <input name="goepower_username" id="goepower_username" type="text" style="width: 350px;" value="<?php echo uDrawUtil::esc_string($_udraw_settings['goepower_username']); ?>" class="">
                </td>
            </tr>
            <tr valign="top">
                <th scope="row" class="titledesc">
                ...
                <td class="forminp forminp-text">
                    <input name="goepower_password" id="goepower_password" type="password" style="width: 350px;" value="<?php echo uDrawUtil::esc_string($_udraw_settings['goepower_password']); ?>" class="">
                </td>
            </tr>                          
            <tr valign="top">
                <th scope="row" class="titledesc">
                ...
                <td class="forminp forminp-text">
                    <input name="goepower_api_key" id="goepower_api_key" type="text" style="width: 350px;" value="<?php echo uDrawUtil::esc_string($_udraw_settings['goepower_api_key']); ?>" class="">
                </td>
            </tr>
            <tr valign="top">
                <th scope="row" class="titledesc">
                ...
                <td class="forminp forminp-text">
                    <input name="goepower_producer_id" id="goepower_producer_id" type="text" style="width: 50px;" value="<?php echo uDrawUtil::esc_string($_udraw_settings['goepower_producer_id']); ?>" class="">
                </td>
            </tr>            
            <?php
                if (strlen($_udraw_settings['goepower_api_key']) > 1) {
                            ...
                            <?php                                
                                foreach ($_goepower_companies as $_company) {
                                    if ($_company->CompanyID == $_udraw_settings['goepower_company_id']) {
                                        echo "<option class=\"level-0\" value=\"". uDrawUtil::esc_string($_company->CompanyID) ."\" selected>". uDrawUtil::esc_string($_company->DisplayName) ."</option>";
                                    } else {
                                        echo "<option class=\"level-0\" value=\"". uDrawUtil::esc_string($_company->CompanyID) ."\">". uDrawUtil::esc_string($_company->DisplayName) ."</option>";
                                    }
                                }
                            ?>                           
                            </select>
                    ...
                    <tr valign="top">
                        ...
                        <td class="forminp forminp-text">
                            <input name="goepower_additional_notify_email" id="goepower_additional_notify_email" type="text" style="width: 350px;" value="<?php echo uDrawUtil::esc_string($_udraw_settings['goepower_additional_notify_email']); ?>" class="">
                    ...
                    <tr valign="top">
                        ...
                        <td class="forminp forminp-text">
                            <input name="loading_animation_link" id="loading_animation_link" type="text" style="width: 350px;" value="<?php echo uDrawUtil::esc_string($_udraw_settings['loading_animation_link']); ?>" class="">
                    ...
                    <tr valign="top">
                        ...
                        <td class="forminp forminp-text">
                            <textarea name="approve_proof_text" id="approve_proof_text" type="text" style="width: 350px;" value="<?php echo uDrawUtil::esc_string($_udraw_settings['approve_proof_text']); ?>" class=""><?php echo uDrawUtil::esc_string($_udraw_settings['approve_proof_text']); ?></textarea>
                        </td>
                    </tr>
                    ...
                    <tr valign="top" class="">
                        ...
                        <td class="forminp forminp-checkbox">
                            <fieldset>
                                <textarea name="udraw_pdf_template_html_hook" id="udraw_pdf_template_html_hook" rows="7" cols="100" style="display:none;"><?php echo stripcslashes(htmlspecialchars_decode(esc_html($_udraw_settings['udraw_pdf_template_html_hook'])));?></textarea>
                    ...
                    <tr valign="top" class="">
                        ...
                        <td class="forminp forminp-checkbox">
                            <fieldset>
                                <textarea name="udraw_pdf_template_css_hook" id="udraw_pdf_template_css_hook" rows="7" cols="100" style="display:none;"><?php echo (htmlspecialchars($_udraw_settings['udraw_pdf_template_css_hook'], ENT_NOQUOTES)); ?></textarea>
                                <legend class="screen-reader-text"><span><?php _e('Custom CSS Hook', 'udraw') ?></span></legend>
                    ...
                    <tr valign="top" class="">
                        ...
                        <td class="forminp forminp-checkbox">
                            <fieldset>
                                <textarea name="udraw_pdf_template_js_hook" id="udraw_pdf_template_js_hook" rows="7" cols="100" style="display:none;"><?php echo (htmlspecialchars($_udraw_settings['udraw_pdf_template_js_hook'], ENT_NOQUOTES)); ?></textarea>
                                <legend class="screen-reader-text"><span><?php _e('Custom JS Hook', 'udraw') ?></span></legend>
    ...
    <script>
        ...
        jQuery(document).ready(function ($) {
            jQuery('#udraw_price_matrix_allowed_file_types').dropdownchecklist(
                {
                    width: 350,
