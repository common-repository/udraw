...
<?php 
        ...
        ?>
        <button type="submit" <?php echo htmlspecialchars($style, ENT_NOQUOTES); ?> id="udraw-options-submit-form-btn" class="single_add_to_cart_button button alt"><?php echo esc_html($product->single_add_to_cart_text() ); ?></button>
...
$_cart_item_key = (isset($_REQUEST['cart_item_key'])) ? uDrawUtil::sanitize_variables($_REQUEST['cart_item_key']) : '';
