<?php
error_log(print_r('I AM RUNNING...', true));
                                ...
                                <table class="variations" cellspacing="0">
                                    ...
                                    <?php $loop = 0; foreach ( $attributes as $name => $options ) : $loop++; ?>
                                        <tr>
                                            ...
                                            <td class="value"><select id="<?php echo uDrawUtil::esc_string( sanitize_title( $name ) ); ?>" name="attribute_<?php echo sanitize_title( $name ); ?>" data-attribute_name="attribute_<?php echo sanitize_title( $name ); ?>">
