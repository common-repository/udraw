...
<div class="wrap">
    ...
    <input type="text" name="template_name" placeholder="Template name" value="<?php echo uDrawUtil::esc_string($name); ?>" />
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <a href="#" class="object_align btn btn-outline-secondary" data-align="left" data-orientation="horizontal">
                                        <img src="<?php echo uDrawUtil::esc_string(UDRAW_PLUGIN_URL) ?>/text-builder/images/align-left.png" />
                                    </a>
                                    <a href="#" class="object_align btn btn-outline-secondary" data-align="middle" data-orientation="horizontal">
                                        <img src="<?php echo uDrawUtil::esc_string(UDRAW_PLUGIN_URL) ?>/text-builder/images/align-horizontal-middle.png" />
                                    </a>
                                    <a href="#" class="object_align btn btn-outline-secondary" data-align="right" data-orientation="horizontal">
                                        <img src="<?php echo uDrawUtil::esc_string(UDRAW_PLUGIN_URL) ?>/text-builder/images/align-right.png" />
                                    </a>
                                    <a href="#" class="object_align btn btn-outline-secondary" data-align="top" data-orientation="vertical">
                                        <img src="<?php echo uDrawUtil::esc_string(UDRAW_PLUGIN_URL) ?>/text-builder/images/align-top.png" />
                                    </a>
                                    <a href="#" class="object_align btn btn-outline-secondary" data-align="middle" data-orientation="vertical">
                                        <img src="<?php echo uDrawUtil::esc_string(UDRAW_PLUGIN_URL) ?>/text-builder/images/align-vertical-middle.png" />
                                    </a>
                                    <a href="#" class="object_align btn btn-outline-secondary" data-align="bottom" data-orientation="vertical">
                                        <img src="<?php echo uDrawUtil::esc_string(UDRAW_PLUGIN_URL) ?>/text-builder/images/align-bottom.png" />
                                    </a>
                                </div>
                            </div>
...
<script>
    jQuery(document).ready(function($){            
        ...
        RacadTextBuilder.settings.output_path       = '<?php echo uDrawUtil::esc_string($_output_path_url); ?>';
        RacadTextBuilder.settings.unique_id         = '<?php echo uDrawUtil::esc_string($key); ?>';
        RacadTextBuilder.settings.template_id       =  <?php echo uDrawUtil::esc_string($template_id); ?>;
