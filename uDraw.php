...
/* SITE CDN DEFINITION - PRESSABLE SITES ONLY */
...
/* PLUGIN DIRECTORY DEFINITIONS END */

/* BOOTSTRAP DEFINITIONS */
if (!defined('UDRAW_BOOTSTRAP_JS')) {
    define('UDRAW_BOOTSTRAP_JS', 'https://udraw-app.racadtech.com/includes/thirdparty/bootstrap-5.2.0/js/bootstrap.bundle.min.js');
}

if (!defined('UDRAW_BOOTSTRAP_CSS')) {
    define('UDRAW_BOOTSTRAP_CSS', 'https://udraw-app.racadtech.com/includes/thirdparty/bootstrap-5.2.0/css/bootstrap.min.css');
}

if (!defined('UDRAW_BOOTSTRAP_THEME_CSS')) {
    define('UDRAW_BOOTSTRAP_THEME_CSS', plugins_url('designer/includes/css/udraw-bootstrap-theme.css', __FILE__));
}

if (!defined('UDRAW_BOOTSTRAP_DESIGNER_CSS')) {
    define('UDRAW_BOOTSTRAP_DESIGNER_CSS', plugins_url('designer/includes/css/udraw-bootstrap.css', __FILE__));
}
/* BOOTSTRAP DEFINITIONS END */

/* JQUERY UI DEFINITIONS */
if (!defined('UDRAW_JQUERY_UI_CSS')) {
    define('UDRAW_JQUERY_UI_CSS', 'https://udraw-app.racadtech.com/includes/thirdparty/jquery-ui-1.11.1.custom/jquery-ui.min.css');
}

if (!defined('UDRAW_JQUERY_UI_THEME_CSS')) {
    define('UDRAW_JQUERY_UI_THEME_CSS', 'https://udraw-app.racadtech.com/includes/thirdparty/jquery-ui-1.11.1.custom/jquery-ui.theme.min.css');
}

if (!defined('UDRAW_JQUERY_SMOOTHNESS_CSS')) {
    define('UDRAW_JQUERY_SMOOTHNESS_CSS', 'https://udraw-app.racadtech.com/includes/thirdparty/jQuery-smoothness/jquery-ui.min.css');
}
/* JQUERY UI DEFINITIONS END */

if (!defined('UDRAW_FONTAWESOME_CSS')) {
    define('UDRAW_FONTAWESOME_CSS', 'https://udraw-app.racadtech.com/includes/thirdparty/font-awesome-5.7.0/css/all.min.css');
}

/* WEB FONT LOADER DEFINITION */
if (!defined('UDRAW_WEBFONT_JS')) {
    define('UDRAW_WEBFONT_JS', 'https://udraw-app.racadtech.com/includes/thirdparty/webfont/webfont.js');
}

if (!defined('UDRAW_CHOSEN_JS')) {
    define('UDRAW_CHOSEN_JS', 'https://udraw-app.racadtech.com/includes/thirdparty/chosen_v1.4.2/chosen.jquery.min.js');    
}

if (!defined('UDRAW_CHOSEN_CSS')) {
    define('UDRAW_CHOSEN_CSS', 'https://udraw-app.racadtech.com/includes/thirdparty/chosen_v1.4.2/chosen.min.css');    
}

/* SELECT2 JS DEFINITIONS */
if (!defined('UDRAW_SELECT2_JS')) {
    define('UDRAW_SELECT2_JS', 'https://udraw-app.racadtech.com/includes/thirdparty/select2-4.0.13/select2.min.js');    
}

if (!defined('UDRAW_SELECT2_CSS')) {
    define('UDRAW_SELECT2_CSS', 'https://udraw-app.racadtech.com/includes/thirdparty/select2-4.0.13/select2.min.css');     
}
/* SELECT2 JS DEFINITIONS END */

/* ACE EDITOR DEFINITIONS */
if (!defined('UDRAW_ACE_JS')) {
    define('UDRAW_ACE_JS', 'https://udraw-app.racadtech.com/includes/thirdparty/ace-1.7.1/ace.js');    
}

if (!defined('UDRAW_ACE_MODE_JAVASCRIPT_JS')) {
    define('UDRAW_ACE_MODE_JAVASCRIPT_JS', 'https://udraw-app.racadtech.com/includes/thirdparty/ace-1.7.1/mode-javascript.js');     
}

if (!defined('UDRAW_ACE_MODE_CSS_JS')) {
    define('UDRAW_ACE_MODE_CSS_JS', 'https://udraw-app.racadtech.com/includes/thirdparty/ace-1.7.1/mode-css.js');    

}

if (!defined('UDRAW_ACE_THEME_CHROME_JS')) {
    define('UDRAW_ACE_THEME_CHROME_JS', 'https://udraw-app.racadtech.com/includes/thirdparty/ace-1.7.1/theme-chrome.js');    
}

if (!defined('UDRAW_ACE_WORKER_JAVASCRIPT_JS')) {
    define('UDRAW_ACE_WORKER_JAVASCRIPT_JS', 'https://udraw-app.racadtech.com/includes/thirdparty/ace-1.7.1/worker-javascript.js');    
}

if (!defined('UDRAW_ACE_WORKER_CSS_JS')) {
    define('UDRAW_ACE_WORKER_CSS_JS', 'https://udraw-app.racadtech.com/includes/thirdparty/ace-1.7.1/worker-css.js');    
}
/* ACE EDITOR DEFINITIONS END */

/* JQUERY TAGS INPUT DEFINITIONS */
if (!defined('UDRAW_TAGS_INPUT_CSS')) {
    define('UDRAW_TAGS_INPUT_CSS', 'https://udraw-app.racadtech.com/includes/thirdparty/jQuery-Tags-Input/jquery.tagsinput.css');    
}

if (!defined('UDRAW_TAGS_INPUT_JS')) {
    define('UDRAW_TAGS_INPUT_JS', 'https://udraw-app.racadtech.com/includes/thirdparty/jQuery-Tags-Input/jquery.tagsinput.min.js');    
}
/* JQUERY TAGS INPUT DEFINITIONS ENDS*/

/* JQUERY PANZOOM DEFINITION */
/* Note: Doesn't look like it is being used any where but offloaded and keeping the reference for now. */
if (!defined('UDRAW_PANZOOM_JS')) {
    define('UDRAW_PANZOOM_JS', 'https://udraw-app.racadtech.com/includes/thirdparty/panzoom/jquery.panzoom.js');
}

/* DROPDOWN CHECKLIST DEFINITION */
if (!defined('UDRAW_CHECKLIST_JS')) {
    define('UDRAW_CHECKLIST_JS', 'https://udraw-app.racadtech.com/includes/thirdparty/ui-checklist/ui.dropdownchecklist.min.js');
}

/* TINYMCE DEFINITIONS */

if (!defined('UDRAW_TINYMCE')) {
    define('UDRAW_TINYMCE', 'https://udraw-app.racadtech.com/includes/thirdparty/tinymce/tinymce.min.js');
}

if (!defined('UDRAW_TINYMCE_JQUERY')) {
    define('UDRAW_TINYMCE_JQUERY', 'https://udraw-app.racadtech.com/includes/thirdparty/tinymce/tinymce-jquery.min.js');
}

/* TINYMCE DEFINITIONS ENDS */

/* CONVERT SERVER DEFINITION */
...
if (!defined('UDRAW_DRAW_SERVER_URL')) {
    if (substr(OPENSSL_VERSION_TEXT, 0, 10) === "OpenSSL 0.") {
        ...
        define('UDRAW_API_3_SERVER_URL', 'http://click2order.eu/');
        ...
        define('UDRAW_API_3_SERVER_URL', 'https://click2order.eu/');
...
if (!class_exists('uDraw')) {
    ...
    class uDraw {
        ...
        public function init_udraw_plugin() {
            ...
            require_once(dirname(__FILE__). '/classes/uDrawSchedules.class.php');
            ...
            // init uDrawSchedules
            $uDrawSchedules = new uDrawSchedules();
            $uDrawSchedules->init();
            ...
            if ($post_type == "product") {
                if (isset($_GET['udraw_template_id']) && isset($_GET['udraw_action'])) {
                    if ($_GET['udraw_action'] == "new-product") {
                        $this->replace_all_product_images(uDrawUtil::sanitize_variables($_GET['udraw_template_id']), $post->ID);                        
                    } else if ($_GET['udraw_action'] == "new-block-product") {
                        $this->replace_block_product_image(uDrawUtil::sanitize_variables($_GET['udraw_template_id']), $post->ID);
                    }else if ($_GET['udraw_action'] == "new-xmpie-product") {
                        $this->replace_xmpie_product_image(uDrawUtil::sanitize_variables($_GET['udraw_template_id']), $post->ID);
                    }
                }
            }
        }
        ...
        public function uDraw_manage_templates_page() {
            ...
            wp_register_script('udraw_base64_js', 'https://udraw-app.racadtech.com/includes/thirdparty/misc/Base64.js');
        ...
        public function udraw_edit_text_template() {
            ...
            wp_enqueue_style('udraw_fontawesome_css', UDRAW_FONTAWESOME_CSS, array(), null );
        ...
        public function uDraw_settings_page() {
            ...
            wp_register_script('languageList_js', 'https://udraw-app.racadtech.com/includes/thirdparty/misc/languageList.js');
            ...
            if (isset($_GET['udraw_rebuild_pdf']) && isset($_GET['post']) ) {
                if ($_GET['udraw_rebuild_pdf'] == "true") {
                    ...
                    <script>
                        ...
                        var udraw_rebuild_order_id = '<?php echo uDrawUtil::esc_string($_GET['post']); ?>';
            ...
            if ( uDraw::is_udraw_okay() && $sent_to_admin ) {
                for ($x = 0; $x < count($item_keys); $x++) {
                    ...
                    if($product_type == 'designer' || $product_type == 'blocks' || $product_type == 'xmpie'){
                        ...
                        echo '<br /><strong>'. uDrawUtil::esc_string($items[$item_keys[$x]]["name"]) . '</strong> : <a class="downloadPDF" href="' . uDrawUtil::esc_string(UDRAW_ORDERS_URL) . uDrawUtil::esc_string($pdf_download_link) . '">Download PDF</a>';
                        ...
                        if (count($uploaded_files) > 0) {
                            foreach ($uploaded_files as $upload_file) {
								echo '<p>Attached: '. uDrawUtil::esc_string($upload_file->name) . "<a href='". uDrawUtil::esc_string($upload_file->url) ."'> Download File</a></p>";
                            }
			            }
                    } else if ($product_type == 'book-upload') {
						$uploaded_doc_url = $udraw_data['udraw-book-product-url'];
						echo '<p>Attached: ' . "<a href='". uDrawUtil::esc_string($uploaded_doc_url) ."'>Download File</a></p>";
					}
                }
                ...
                foreach($orderItems as $key => $product) {
                    ...
                    if ($downloadable === 'yes') {
                        ...
                        if($product_type == 'designer' || $product_type == 'blocks' || $product_type == 'xmpie'){
                            echo '<strong>'. uDrawUtil::esc_string($orderItems[$item_id]["name"]) . '</strong> : <a class="downloadPDF" href="' . uDrawUtil::esc_string(UDRAW_ORDERS_URL) . uDrawUtil::esc_string($pdf_download_link) . '">Download PDF</a>';
        ...
        /** Responsible for triggering genarate pdf function multiple times which also submits to 3rd party platforms multiple times. */
        ...
        public function woo_udraw_save_custom_fields($post_id, $post) {
            ...
            if ($uDrawProduct == 'true') {
                ...
                $template_id = (isset($_POST['udraw_template_id'])) ? uDrawUtil::sanitize_variables($_POST['udraw_template_id']) : NULL;
                $block_id = (isset($_POST['udraw_block_template_id'])) ? uDrawUtil::sanitize_variables($_POST['udraw_block_template_id']) : NULL;
                $xmpie_id = (isset($_POST['udraw_xmpie_template_id'])) ? uDrawUtil::sanitize_variables($_POST['udraw_xmpie_template_id']) : NULL;
                $use_colour_palette = (isset($_POST['udraw_pdf_xmpie_use_colour_palette'])) ? uDrawUtil::sanitize_variables($_POST['udraw_pdf_xmpie_use_colour_palette']) : NULL;
                $allow_print_save = (isset($_POST['udraw_pdf_allow_print_save'])) ? uDrawUtil::sanitize_variables($_POST['udraw_pdf_allow_print_save']) : NULL;
                $allow_download_design = (isset($_POST['udraw_allow_customer_download_design'])) ? uDrawUtil::sanitize_variables($_POST['udraw_allow_customer_download_design']) : NULL;
                $udraw_designer_skin_override = (isset($_POST['udraw_designer_skin_override'])) ? uDrawUtil::sanitize_variables($_POST['udraw_designer_skin_override']) : false;
                $udraw_designer_skin = (isset($_POST['udraw_designer_skin'])) ? uDrawUtil::sanitize_variables($_POST['udraw_designer_skin']) : NULL;
                $udraw_pdf_layout_override = (isset($_POST['udraw_pdf_layout_override'])) ? uDrawUtil::sanitize_variables($_POST['udraw_pdf_layout_override']) : false;
                $udraw_pdf_layout = (isset($_POST['udraw_pdf_layout'])) ? uDrawUtil::sanitize_variables($_POST['udraw_pdf_layout']) : NULL;
                ...
                $options_first = (isset($_POST['udraw_display_options_page_first'])) ? uDrawUtil::sanitize_variables($_POST['udraw_display_options_page_first']) : false;
                $allow_upload = (isset($_POST['udraw_allow_upload_artwork'])) ? uDrawUtil::sanitize_variables($_POST['udraw_allow_upload_artwork']) : false;
                $allow_double_upload = (isset($_POST['udraw_double_allow_upload_artwork'])) ? uDrawUtil::sanitize_variables($_POST['udraw_double_allow_upload_artwork']) : false;
                $files_allowed = (isset($_POST['max_files_allowed'])) ? uDrawUtil::sanitize_variables($_POST['max_files_allowed']) : NULL;
                $allow_convert = (isset($_POST['udraw_allow_convert_pdf'])) ? uDrawUtil::sanitize_variables($_POST['udraw_allow_convert_pdf']) : false;
                $allow_post_payment_download = (isset($_POST['udraw_allow_post_payment_download'])) ? uDrawUtil::sanitize_variables($_POST['udraw_allow_post_payment_download']) : false;
                $allow_design_bypass = (isset($_POST['udraw_allow_design_bypass'])) ? uDrawUtil::sanitize_variables($_POST['udraw_allow_design_bypass']) : false;
                $preset_private_image_categories = (isset($_POST['_udraw_preset_private_image_categories'])) ? uDrawUtil::sanitize_variables($_POST['_udraw_preset_private_image_categories']) : false;
                $disable_cart_pdf_preview_thumbnail = (isset($_POST['udraw_disable_cart_preview_thumbnail'])) ? uDrawUtil::sanitize_variables($_POST['udraw_disable_cart_preview_thumbnail']) : false;
                update_post_meta($post_id, '_udraw_disable_cart_preview_thumbnail', $disable_cart_pdf_preview_thumbnail);
                ...
                $private_product = (isset($_POST['udraw_is_private_product'])) ? uDrawUtil::sanitize_variables($_POST['udraw_is_private_product']) : NULL;
                ...
                $price_matrix_isset = (isset($_POST['udraw_is_price_matrix_set'])) ? uDrawUtil::sanitize_variables($_POST['udraw_is_price_matrix_set']) : NULL;
                $price_matrix_list = (isset($_POST['udraw_price_matrix_list'])) ? uDrawUtil::sanitize_variables($_POST['udraw_price_matrix_list']) : NULL;
                $disable_price_matrix_size_check = (isset($_POST['udraw_price_matrix_disable_size_check'])) ? uDrawUtil::sanitize_variables($_POST['udraw_price_matrix_disable_size_check']) : NULL;
                ...
                if (isset($_POST['udraw_public_key'])) {
                    update_post_meta($post_id, '_udraw_public_key', uDrawUtil::sanitize_variables($_POST['udraw_public_key']));
                }
        ...
        public function woo_udraw_add_to_cart_cat_text($handler, $product) {
            ...
            if (self::is_udraw_product($product_id)) {
                ...
                return sprintf('<a href="%s" rel="nofollow" data-product_id="%s" data-product_sku="%s" class="button product_type_%s">%s</a>', esc_url(get_permalink($product_id)), uDrawUtil::esc_string($product_id), uDrawUtil::esc_string($product->get_sku()), uDrawUtil::esc_string($product_type), esc_html('Order Now'));
            }
            ...
            if (strlen($udraw_price_matrix_access_key) > 0) {
                ...
                return sprintf('<a href="%s" rel="nofollow" data-product_id="%s" data-product_sku="%s" class="button product_type_%s">%s</a>', esc_url(get_permalink($product_id)), uDrawUtil::esc_string($product_id), uDrawUtil::esc_string($product->get_sku()), uDrawUtil::esc_string($product_type), esc_html('View Now'));
            }
            return $handler;
        }
        ...
        public function woo_udraw_add_product_designer() {
            ...
            if (self::is_udraw_product($post->ID)) {
                ...
                echo "<script>var templateCount=". uDrawUtil::esc_string($templateCount) .";</script>";
                ...
                if ( (strlen($_blockProductId) > 0) || ( is_array($_blockProductId) && count($_blockProductId) > 0)  ){
                    ...
                    wp_register_style('slim_css', 'https://udraw-app.racadtech.com/includes/thirdparty/misc/slim.min.css');
        ...
        public function woo_udraw_add_cart_item_data($cart_item_meta, $product_id) {           
            ...
            if (self::is_udraw_product($product_id)) {
                ...
                $cart_item_meta['udraw_data']['udraw_product'] = uDrawUtil::sanitize_variables($_POST['udraw_product']);
                $cart_item_meta['udraw_data']['udraw_product_cart_item_key'] = uDrawUtil::sanitize_variables($_POST['udraw_product_cart_item_key']);
                
                // Store Design Data on the file system.
                if (strlen($_POST['udraw_product_data']) > 0) {
                    $file_path = str_replace(UDRAW_STORAGE_URL, UDRAW_STORAGE_DIR, uDrawUtil::sanitize_variables($_POST['udraw_product_data']));
                    //check file extension. If it's not xml, skip process. We can assume it's an update
                    $ext = pathinfo($file_path, PATHINFO_EXTENSION);
                    if ($ext === 'xml') {
                        if (file_exists($file_path)) { 
                            $file_path = str_replace(UDRAW_STORAGE_DIR, UDRAW_STORAGE_URL, $file_path);
                            $design_data = $uDrawUtil->get_web_contents($file_path);
                        } else {
                            $design_data = base64_decode($_POST['udraw_product_data']);
                        }
                        
                        if (!$uDrawUtil->is_xml_valid($design_data)) {
                            error_log("Invalid uDraw Product Data Found.");
                        ...
                        if ($this->startsWith($_POST['udraw_product_preview'], 'data:image')) {
                            ...
                            $cart_item_meta['udraw_data']['udraw_product_preview'] = uDrawUtil::sanitize_variables($_POST['udraw_product_preview']);
                        }
                    } else {
                        $cart_item_meta['udraw_data']['udraw_product_preview'] = uDrawUtil::sanitize_variables($_POST['udraw_product_preview']);
                        $cart_item_meta['udraw_data']['udraw_product_data'] = str_replace(UDRAW_STORAGE_URL, '', uDrawUtil::sanitize_variables($_POST['udraw_product_data']));
                    }
                }
                                
                // PDF Blocks Options
                $cart_item_meta['udraw_data']['udraw_pdf_block_product_id'] = (isset($_POST['udraw_pdf_block_product_id'])) ? uDrawUtil::sanitize_variables($_POST['udraw_pdf_block_product_id']) : NULL;
                ...
                if (isset($_POST['udraw_pdf_block_product_id']) && strlen($_POST['udraw_pdf_block_product_id']) > 0) {
                    ...
                    $pdfThumb = uDrawUtil::sanitize_variables($_POST['udraw_pdf_block_product_thumbnail']);
                    if ($this->endsWith($pdfThumb, '.pdf')){
                        ...
                        $data = array(
                            'pdfDocument' => str_replace('localhost', 'udraw-wordpress.ngrok.io', $pdfThumb),
                    ...
                    if (isset($_POST['udraw_pdf_order_info']) && strlen($_POST['udraw_pdf_order_info']) > 0) {
                        $cart_item_meta['udraw_data']['udraw_pdf_order_info'] = uDrawUtil::sanitize_variables($_POST['udraw_pdf_order_info']);
                    }
                }
                
                // XMPie Options
                $cart_item_meta['udraw_data']['udraw_pdf_xmpie_product_id'] = (isset($_POST['udraw_pdf_xmpie_product_id'])) ? uDrawUtil::sanitize_variables($_POST['udraw_pdf_xmpie_product_id']) : NULL;   
                ...
                $cart_item_meta['udraw_data']['udraw_options_uploaded_files'] = (isset($_POST['udraw_options_uploaded_files'])) ? uDrawUtil::sanitize_variables($_POST['udraw_options_uploaded_files']) : NULL;
                // Note if its a converted PDF design
                $cart_item_meta['udraw_data']['udraw_options_converted_pdf'] = (isset($_POST['udraw_options_converted_pdf'])) ? uDrawUtil::sanitize_variables($_POST['udraw_options_converted_pdf']) : NULL;
                $cart_item_meta['udraw_data']['udraw_options_uploaded_files_preview'] = (isset($_POST['udraw_options_uploaded_files_preview'])) ? uDrawUtil::sanitize_variables($_POST['udraw_options_uploaded_files_preview']) : NULL;

                $disableCartPreviewThumbnail = get_post_meta($product_id, '_udraw_disable_cart_preview_thumbnail', true); 
                if ($disableCartPreviewThumbnail !== "yes" ) {
					...
					if (strlen($cart_item_meta['udraw_data']['udraw_options_uploaded_files']) > 0) {
						...
						foreach ($uploaded_files as $upload_file) {
							if ($this->endsWith($upload_file->url, ".pdf")) {          
								// Pass the PDF document to remote converting server and convert to PNG document.
								$data = array(
									'pdfDocument' => str_replace('localhost', 'udraw-wordpress.ngrok.io', $upload_file->url),
									'key' => uDraw::get_udraw_activation_key(),
									'resolution' => 'low'
								);
								...
								if ($udraw_convert_response->isSuccess) {
									if (is_array($udraw_convert_response->data)) {
										$uDrawConnect->__downloadFile(UDRAW_CONVERT_SERVER_URL . $udraw_convert_response->data[0], UDRAW_TEMP_UPLOAD_DIR . $upload_file->name . '.jpg');
										$cart_item_meta['udraw_data']['udraw_options_uploaded_files_preview'] = UDRAW_TEMP_UPLOAD_URL . $upload_file->name . '.jpg';
									}
								}                            
								break;
							}
                    ...
                    $cart_item_meta['udraw_data']['udraw_options_uploaded_files_preview'] = uDrawUtil::sanitize_variables($_POST['udraw_product_preview']);
                }
        ...
        public function woo_udraw_get_item_data($other_data, $cart_item) {
            ...
            if ( (isset($udraw_data['udraw_product_data']) && $udraw_data['udraw_product_data']) ||
                 (isset($udraw_data['udraw_pdf_block_product_id'])) || (isset($udraw_data['udraw_options_uploaded_files']) && strlen($udraw_data['udraw_options_uploaded_files']) > 0)) {
        ...
        public function woo_udraw_after_order_details($order) {
            ...
            wp_register_script('udraw_base64_js', 'https://udraw-app.racadtech.com/includes/thirdparty/misc/Base64.js');
            wp_register_script('pinitjs', "//assets.pinterest.com/js/pinit.js");
            wp_get_script_tag(
                array(
                    'async' => true,
                    'defer' => true,
                    'src'       => esc_url( '//assets.pinterest.com/js/pinit.js' ),
                )
            );
            wp_enqueue_script('udraw_base64_js');
            ...
            foreach($orderItems as $key => $product) {
                ...
                if ($downloadable === 'yes') {
                    ...
                    echo '<tr>';
                    echo '<td><label>'. uDrawUtil::esc_string($product["name"]) .'</label></td>';
                    echo '<td>';

                    if (strlen($_pdf_path) > 0 ) {
                        echo '<a href="' . uDrawUtil::esc_string($_pdf_path) . '" target="_blank"  class="pdfDownload">Download PDF</a>';
                    } else {
                    ...
                    echo '<td><a href="' . uDrawUtil::esc_string(UDRAW_ORDERS_URL) . uDrawUtil::esc_string($_png_path) . '" target="_blank" class="pngDownload">Download PNG</a></td>';
                    }

                    if (strlen($_jpg_path) > 0) {
                        echo '<td><a href="#" onclick="window.open(\''. uDrawUtil::esc_string($_jpg_path) .'\'); return false;" class="jpgDownload">Download JPG</a></td>';
                    }
                    echo '<td>';
                    //Share PNG
                    if (strlen($fbAppId) > 0) {
                        ?>
                        <div class="fb-share-button" data-href="<?php echo uDrawUtil::esc_string($_png_path) ?>" data-layout="button" data-mobile-iframe="true" style="padding-bottom: 5px;"></div>
                        <div id="fb-root"></div>
                        <script>
                        (function(d, s, id) {
                            ...
                            js.src = "//connect.facebook.net/en_US/sdk.js#xfbml=1&version=v2.6&appId=<?php echo uDrawUtil::esc_string($fbAppId) ?>";
                    ...
                    ?>
                    <a href="https://twitter.com/share" class="twitter-share-button" data-url="<?php echo uDrawUtil::esc_string($_png_path) ?>" data-text="My design | ">Tweet</a>
                    ...
                    <a class="linkedin-share-button" href="https://www.linkedin.com/shareArticle?mini=true&title=<?php echo uDrawUtil::esc_string($product["name"]); ?>&source=<?php echo get_bloginfo( 'name' ); ?>&url=<?php echo uDrawUtil::esc_string(UDRAW_ORDERS_URL) . uDrawUtil::esc_string($_png_path); ?>" style="display: block;">Share on LinkedIn</a>
                    <a href="mailto:?body=<?php echo uDrawUtil::esc_string($_png_path) ?>" class="button" style="padding: 10px; height: initial;" onclick="window.open(this.href, 'Email',
'left=20,top=20,width=500,height=500,toolbar=1,resizable=0'); open_email_tip(this); return false;"><span style="font-size: 12px;">Email</span></a>
            ...
            if( isset( $item['udraw_data']) ) {
                ...
                if (isset($udrawData['udraw_price_matrix_name'])) {
                    ...
                    if (isset($udrawData['udraw_options_uploaded_files'])) {
                        ...
                        if (gettype($uploaded_files) === 'array') {
        ...
        public function udraw_wp_nav_menu_objects($sorted_menu_items, $args) {
            ...
            for ($x = 1; $x <= count($sorted_menu_items); $x++) {
                ...
                // Handle Private Template Menu Item.
        ...
        public function registerStyles() {
            // Register Styles
            wp_register_style('udraw_bootstrap_designer_css', UDRAW_BOOTSTRAP_DESIGNER_CSS);
            wp_register_style('udraw_bootstrap_theme_css', UDRAW_BOOTSTRAP_THEME_CSS);
            ...
            // Enqueue Styles
            wp_enqueue_style('udraw_bootstrap_designer_css');
        ...
        {
            wp_register_script('tinymce', UDRAW_TINYMCE);
            wp_register_script('tinymce-jquery', UDRAW_TINYMCE_JQUERY);
        ...
        public function registerjQueryFileUpload() {            
            ...
            wp_enqueue_style('udraw_fileuploader_css', 'https://udraw-app.racadtech.com/includes/thirdparty/jquery-fileupload/jquery.fileupload.css');
            
            $this->register_jquery_ui();
            wp_enqueue_script('udraw_fileuploader_js', 'https://udraw-app.racadtech.com/includes/thirdparty/jquery-fileupload/jquery.fileupload.js');
            wp_enqueue_script('udraw_iframe-transport_js', 'https://udraw-app.racadtech.com/includes/thirdparty/jquery-fileupload/jquery.iframe-transport.js');
            wp_enqueue_script('udraw_iframe-transport_js', 'https://udraw-app.racadtech.com/includes/thirdparty/jquery-fileupload/jquery.xdr-transport.js');
        }
        
        public function registerXMPieColourPicker() {
            wp_register_style('udraw_xmpie_colour_picker_css', 'https://udraw-app.racadtech.com/includes/thirdparty/ColorPicker/jquery.colorpicker.css');
            wp_register_script('udraw_xmpie_colour_picker_js', 'https://udraw-app.racadtech.com/includes/thirdparty/ColorPicker/jquery.colorpicker.js');
        ...
        public function registerPDFBlocksJS() {
            ...
            wp_register_script('udraw_base64_js', 'https://udraw-app.racadtech.com/includes/thirdparty/misc/webtoolkit.base64.js');
...
// Check PHP version 7.1.30+ 
if (version_compare(phpversion(), '7.1.30', '<')) {
...
<div class="notice notice-error">
    <p style="font-size: 14px;">
        <strong>Important:</strong> uDraw Plugin requires PHP version 7.1.30 or higher. PHP version currently installed is <strong><?php echo uDrawUtil::esc_string(phpversion()); ?></strong> .
    </p>
</div>
<?php
}
...
function udraw_update_notice ($args, $response) {
    ...
    if ( false === $upgrade_notice ) {
        $response = $uDrawUtil->get_web_contents(UDRAW_PLUGIN_URL . '/readme.txt');
