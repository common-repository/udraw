            ...
            <div class="top_strip_container">
                <ul role="tablist" class="menu_ul">
                    <li role="presentation" class="dropdown">
                        <a href="#" data-bs-toggle="dropdown"><i class="fas fa-list" style="margin-right: 5px;"></i><span data-i18n="[html]menu"></span></a>
            ...
            <div class="top_strip_container">
                <div class="product_title_container">
                    ...
                    if (isset($product) && $product !== null) {
                        echo uDrawUtil::esc_string($product->get_title()); 
                    }
                    ?>
                </div>
            </div>
        ...
        <ul class="nav nav-tabs" role="tablist">
            ...
            <?php if ($edit_text_tab && !$admin) { ?>
                <li data-udrawSVG="edit_text_tab" role="presentation">
                    <a href="#edit_text" class="nav-link hidden" aria-controls="edit_text" role="tab" data-bs-toggle="tab"><span data-i18n="[html]edit_text"></span></a>
                </li>
            <?php } ?>
    ...
    <div class="sidebar">
        ...
        <button type="button" class="hover-icon btn btn-default btn-lg" data-udrawSVG="add_image">
            ...
            <button type="button" class="hover-icon btn btn-default btn-lg" data-udrawSVG="document_background_colour">
                <img class="icon" src="<?php echo uDrawUtil::esc_string(UDRAW_SVG_IMAGE_URL) ?>paint_bucket.png" style="margin-left: -4px;">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <button type="button" class="g-signin2" data-theme="dark" style="margin-top: -5px;">
                            <img src="<?php echo uDrawUtil::esc_string(UDRAW_SVG_IMAGE_URL) ?>Google_Photos_icon.svg" class="google_photos small photos_icon"/>
                ...
                <div class="modal-content cornered" style="width: 100%; height: 100%; max-height: 100%;">
                    <div class="modal-header">
                        ...
                        <div class="modal_header_content product_title_container">
                            <?php 
                            if (isset($product) && $product !== null) {
                                uDrawUtil::esc_string($product->get_title()); 
                            }
                            ?>
                        </div>
