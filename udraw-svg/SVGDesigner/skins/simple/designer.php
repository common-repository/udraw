...
<div data-udrawSVG="SVGDesigner">
    ...
    <div class="modal fade" data-udrawSVG="facebook_modal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" data-bs-dismiss="modal" data-udrawSVG="cancel_object_action"><span data-i18n="[html]cancel"></span></button>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="replace_image_browse_container">
                        <div class="replace_method_container">
                            ...
                            <a href="#" class="bulk_image_button" data-bulk_image_type="google_image">
                                <img src="<?php echo uDrawUtil::esc_string(UDRAW_SVG_IMAGE_URL) ?>Google_Photos_icon.svg" style="width: 32px;" />
                                <br />
                            ...
                            <a href="#" class="bulk_image_button" data-bulk_image_type="instagram_image">
                                <img src="<?php echo uDrawUtil::esc_string(UDRAW_SVG_IMAGE_URL) ?>instagram.png" style="width: 32px;" />
                                <br />
    ...
    <div class="modal fade" data-udrawSVG="stock_image_modal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <a href="#" data-bs-dismiss="modal" style="float: right; margin-left: 5px;"><i class="fa fa-times"></i></a>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <a href="#" data-bs-dismiss="modal" style="float: right;"><i class="fa fa-times"></i></a>
                </div>
                <div class="modal-body">
                    <?php if (isset($allow_custom_objects) && $allow_custom_objects) { ?>
                    <div>
