...
<div data-udrawSVG="SVGDesigner">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        ...
                        <li class="dropdown-item">
                            <a href="#" data-udrawSVG="google_images">
                                <img src="<?php echo uDrawUtil::esc_string(UDRAW_SVG_IMAGE_URL) ?>Google_Photos_icon.svg" style="width: 16px; display: inline-block;" />
        ...
        <div class="sidebar has_tabs">
            <ul class="nav nav-tabs" role="tablist">
                <li data-udrawSVG="pages_tab" role="presentation">
                    <a href="#pages" class="nav-link active" aria-controls="pages" role="tab" data-bs-toggle="tab"><span data-i18n="[html]pages"></span></a>
                </li>
                <li data-udrawSVG="edit_text_tab" role="presentation" class="hidden">
                    <a href="#edit_text" class="nav-link" aria-controls="edit_text" role="tab" data-bs-toggle="tab"><span data-i18n="[html]edit_text"></span></a>
                </li>
                <li data-udrawSVG="image_action_tab" role="presentation" class="hidden">
                    <a href="#image_action" class="nav-link" aria-controls="image_action" role="tab" data-bs-toggle="tab"><span data-i18n="[html]images"></span></a>
                </li>
                <?php if ($display_layers || $admin) { ?>
                <li data-udrawSVG="layers_tab" role="presentation">
                    <a href="#layers" class="nav-link" aria-controls="layers" role="tab" data-bs-toggle="tab"><span data-i18n="[html]layers"></span></a>
                </li>
                <?php } ?>
            </ul>
                    ...
                    <div data-udrawSVG="edit_text_modal" class="udraw_modal">
                        ...
                        <div class="more_options_container">
                            ...
                            <div data-udrawSVG="advanced_text_options_container" class="hidden">
                                ...
                                <div class="half">
                                    <div class="quarter"><img class="icon" src="<?php echo uDrawUtil::esc_string(UDRAW_SVG_IMAGE_URL) ?>line_width.png"></div>
                ...
                <div class="modal-body">
                    <div class="add_image_container">
                        ...
                        <button type="button" data-udrawSVG="google_images">
                            <img src="<?php echo uDrawUtil::esc_string(UDRAW_SVG_IMAGE_URL) ?>Google_Photos_icon.svg" class="photos_icon small" />
                            <span data-i18n="[html]google_images"></span>
                        </button>
                        <?php } ?>
                        <?php if ($_udraw_settings['designer_enable_instagram_functions']) { ?>
                        <button type="button" data-udrawSVG="instagram_images">
                            <img src="<?php echo uDrawUtil::esc_string(UDRAW_SVG_IMAGE_URL) ?>instagram.png" class="photos_icon small" />
                            <span data-i18n="[html]instagram_images"></span>
                        </button>
                        <?php } ?>
                    </div>
    ...
    <div class="modal fade udraw_modal" data-udrawSVG="user_image_modal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" data-bs-dismiss="modal" data-i18n="[html]cancel"></button>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <ul data-udrawSVG="image_filters_list">
                            <li>
                                <a href="#" class="image_filter_button btn btn-default" data-filter_type="none">
                                    <img src="<?php echo uDrawUtil::esc_string(UDRAW_SVG_IMAGE_URL) ?>original.png" class="image_filter_thumbnail" />
                                    <span data-i18n="[html]none"></span>
                                </a>
                            </li>
                            <li>
                                <a href="#" class="image_filter_button btn btn-default" data-filter_type="gaussian_blur">
                                    <img src="<?php echo uDrawUtil::esc_string(UDRAW_SVG_IMAGE_URL) ?>gaussian_blur.png" class="image_filter_thumbnail" />
                            ...
                            <li>
                                <a href="#" class="image_filter_button btn btn-default" data-filter_type="horizontal_blur">
                                    <img src="<?php echo uDrawUtil::esc_string(UDRAW_SVG_IMAGE_URL) ?>horizontal_blur.png" class="image_filter_thumbnail" />
                            ...
                            <li>
                                <a href="#" class="image_filter_button btn btn-default" data-filter_type="desaturate">
                                    <img src="<?php echo uDrawUtil::esc_string(UDRAW_SVG_IMAGE_URL) ?>desaturate.png" class="image_filter_thumbnail" />
                                    <span data-i18n="[html]desaturate"></span>
                                </a>
                            </li>
                            <li>
                                <a href="#" class="image_filter_button btn btn-default" data-filter_type="contrast">
                                    <img src="<?php echo uDrawUtil::esc_string(UDRAW_SVG_IMAGE_URL) ?>contrast.png" class="image_filter_thumbnail" />
                                    <span data-i18n="[html]contrast"></span>
                                </a>
                            </li>
                            <li>
                                <a href="#" class="image_filter_button btn btn-default" data-filter_type="sepiatone">
                                    <img src="<?php echo uDrawUtil::esc_string(UDRAW_SVG_IMAGE_URL) ?>sepiatone.png" class="image_filter_thumbnail" />
                                    <span data-i18n="[html]sepiatone"></span>
                                </a>
                            </li>
                            <li>
                                <a href="#" class="image_filter_button btn btn-default" data-filter_type="hue_rotate">
                                    <img src="<?php echo uDrawUtil::esc_string(UDRAW_SVG_IMAGE_URL) ?>hue_rotate.png" class="image_filter_thumbnail" />
                            ...
                            <li>
                                <a href="#" class="image_filter_button btn btn-default" data-filter_type="luminance_to_alpha">
                                    <img src="<?php echo uDrawUtil::esc_string(UDRAW_SVG_IMAGE_URL) ?>luminance_to_alpha.png" class="image_filter_thumbnail" />
                                    <span data-i18n="[html]luminance_to_alpha"></span>
                                </a>
                            </li>
                            <li>
                                <a href="#" class="image_filter_button btn btn-default" data-filter_type="colourize">
                                    <img src="<?php echo uDrawUtil::esc_string(UDRAW_SVG_IMAGE_URL) ?>colourize.png" class="image_filter_thumbnail" />
                            ...
                            <li>
                                <a href="#" class="image_filter_button btn btn-default" data-filter_type="posterize">
                                    <img src="<?php echo uDrawUtil::esc_string(UDRAW_SVG_IMAGE_URL) ?>posterize.png" class="image_filter_thumbnail" />
                                    <span data-i18n="[html]posterize"></span>
                                </a>
                            </li>
                            <li>
                                <a href="#" class="image_filter_button btn btn-default" data-filter_type="darken">
                                    <img src="<?php echo uDrawUtil::esc_string(UDRAW_SVG_IMAGE_URL) ?>darken.png" class="image_filter_thumbnail" />
                            ...
                            <li>
                                <a href="#" class="image_filter_button btn btn-default" data-filter_type="lighten">
                                    <img src="<?php echo uDrawUtil::esc_string(UDRAW_SVG_IMAGE_URL) ?>lighten.png" class="image_filter_thumbnail" />
                            ...
                            <li>
                                <a href="#" class="image_filter_button btn btn-default" data-filter_type="invert">
                                    <img src="<?php echo uDrawUtil::esc_string(UDRAW_SVG_IMAGE_URL) ?>invert.png" class="image_filter_thumbnail" />
                                    <span data-i18n="[html]invert"></span>
                                </a>
                            </li>
                            <li>
                                <a href="#" class="image_filter_button btn btn-default" data-filter_type="gamma_correct_1">
                                    <img src="<?php echo uDrawUtil::esc_string(UDRAW_SVG_IMAGE_URL) ?>gamma_correct_1.png" class="image_filter_thumbnail" />
                            ...
                            <li>
                                <a href="#" class="image_filter_button btn btn-default" data-filter_type="gamma_correct_2">
                                    <img src="<?php echo uDrawUtil::esc_string(UDRAW_SVG_IMAGE_URL) ?>gamma_correct_2.png" class="image_filter_thumbnail" />
    ...
    <div class="modal fade udraw_modal" data-udrawSVG="facebook_modal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <a href="#" data-bs-dismiss="modal" style="float: right; margin-left: 5px;"><i class="fas fa-times"></i></a>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" data-bs-dismiss="modal" data-udrawSVG="cancel_object_action">
                        <span data-i18n="[html]cancel"></span>
                    </button>
                </div>
            </div>
    ...
    <div class="modal fade udraw_modal" data-udrawSVG="google_photos_modal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" data-bs-dismiss="modal"><span data-i18n="[html]cancel"></span></button>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="replace_image_browse_container">
                        <div class="replace_method_container desktop_only">
                            ...
                            <a href="#" class="bulk_image_button" data-bulk_image_type="google_image">
                                <img src="<?php echo uDrawUtil::esc_string(UDRAW_SVG_IMAGE_URL) ?>Google_Photos_icon.svg" class="photos_icon" />
                                <br />
                                <span data-i18n="[html]google_images"></span>
                            </a>
                            <?php } ?>
                            ...
                            <a href="#" class="bulk_image_button" data-bulk_image_type="instagram_image">
                                <img src="<?php echo uDrawUtil::esc_string(UDRAW_SVG_IMAGE_URL) ?>instagram.png" class="photos_icon"/>
                                <br />
                                <span data-i18n="[html]instagram_images"></span>
                            </a>
                            <?php } ?>
