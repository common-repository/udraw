    ...
    class SVG_admin_orders {
        ...
        public function admin_order_item_values ($_product, $item, $item_id) {
            ...
            if (isset($item['udraw_SVG_data'])) {
                ...
                ?>
                    <a href="#TB_inline?width=600&height=550&inlineId=<?php echo uDrawUtil::esc_string($item_id); ?>_preview" class="button button-small button-secondary udraw_svg_control thickbox" onclick="javascript:window.tb_show('View Design', '#TB_inline?width=600&height=550&inlineId=<?php echo uDrawUtil::esc_string($item_id); ?>_preview');">View Design</a>
                    <div id="<?php echo uDrawUtil::esc_string($item_id); ?>_preview" style="display:none;">
                        <div class="preview_container">
                            <div style="display: inline-block; padding: 5px;">
                                <img src="<?php echo uDrawUtil::esc_string($design_page_data) ?>" style="max-width: 250px; max-height: 250px; border: 1px solid #ccc;"/>
                            </div>
                        </div>
                    </div>
                    <?php 
                    ...
                    <a href="#TB_inline?width=800&height=800&inlineId=edit_design" 
                       ...
                       data-order_item_id="<?php echo uDrawUtil::esc_string($item_id) ?>"
                    ...
                    <a href="#"  class="button button-small button-secondary udraw_svg_control download_svg_pdf" data-order_item_id="<?php echo uDrawUtil::esc_string($item_id) ?>" onclick="window.open('<?php echo uDrawUtil::esc_string($pdf_path) ?>')" <?php echo uDrawUtil::esc_string($disabled) ?> ><?php _e('Download PDF', 'udraw_svg'); ?></a>
                    <a href="#" class="button button-small button-secondary udraw_svg_control rebuild_svg_pdf" data-order_item_id="<?php echo uDrawUtil::esc_string($item_id) ?>"><?php _e('Rebuild PDF', 'udraw_svg'); ?></a>
                    ...
                    <script>
                        jQuery(document).ready(function($){
                            ...
                            $('a.rebuild_svg_pdf[data-order_item_id="<?php echo uDrawUtil::esc_string($item_id) ?>"]').on('click', function(){
                                ...
                                $.ajax({
                                    ...
                                    data: {
                                        ...
                                        order_id: <?php echo uDrawUtil::esc_string($post->ID) ?>
                                    },
                            ...
                            if ('<?php echo $pdf_path ?>'.length === 0) {
                                __listen_download(<?php echo uDrawUtil::esc_string($item_id) ?>, function(url){
                                    $('a.download_svg_pdf[data-order_item_id="' + <?php echo uDrawUtil::esc_string($item_id) ?> + '"]').attr({
                                        onclick: 'window.open("' + url + '")',
                                        disabled: false
                                    });
                                });
                ...
                if (isset($data['udraw_SVG_uploaded_artwork'])) {
                    ?>
                    <a href="#TB_inline?width=600&height=550&inlineId=<?php echo uDrawUtil::esc_string($item_id); ?>_uploaded_files" class="button button-small button-secondary udraw_svg_control thickbox" 
                       onclick="javascript:window.tb_show('View Uploaded Files', '#TB_inline?width=600&height=550&inlineId=<?php echo uDrawUtil::esc_string($item_id); ?>_uploaded_files');">
                        <?php _e('View Uploaded Files', 'udraw_svg'); ?>
                    </a>
                    <div id="<?php echo uDrawUtil::esc_string($item_id); ?>_uploaded_files" style="display:none;">
                        <div class="preview_container">
                            <?php
                            ...
                            <div class="row" style="padding: 5px;">
                                ...
                                ?>
                                    <img src="<?php echo uDrawUtil::esc_string($page_obj->url) ?>" class="col" style="max-height: 250px; border: 1px solid #ccc;"/>
                                <?php } 
                                if ($count > 1) {
                                ?>
                                <div class="col">
                                    <span><?php echo uDrawUtil::esc_string($page_name) ?></span>
                                </div>
                                <?php } ?>
                                <div class="col">
                                    <a href="#" onclick="javascript: window.open('<?php echo uDrawUtil::esc_string($page_obj->url) ?>', '_blank');" 
                                    ...
                                    if (response) {
                                        ...
                                        if (svg_url.substring(svg_url.length - 3) === 'svg') {
                                            RacadSVGDesigner.Load.file(svg_url, function () {
                                                ...
                                                RacadSVGDesigner.settings.order_id = <?php echo uDrawUtil::esc_string($post->ID) ?>;
        ...
        public function udraw_svg_update_svg_url () {
            ...
            if (isset($_REQUEST['url'])) {
                $url = uDrawUtil::sanitize_variables($_REQUEST['url']);
                if (isset($_REQUEST['order_item_id'])) {
