...
class uDraw_SVG_Table extends WP_List_Table {
    ...
    function prepare_items() {
        ...
        $orderby = (isset($_REQUEST['orderby'])) ? uDrawUtil::sanitize_variables($_REQUEST['orderby']) : 'date';
        $order = (isset($_REQUEST['order'])) ? uDrawUtil::sanitize_variables($_REQUEST['order']) : 'desc';
