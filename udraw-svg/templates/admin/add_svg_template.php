...
<script>
    function __load_settings() {
        ...
        RacadSVGDesigner.settings.session_id = '<?php echo uDrawUtil::esc_string($session_id) ?>';
    ...
    jQuery(document).ready(function($){
        ...
        window.new_session_id = '<?php echo uDrawUtil::esc_string($session_id); ?>';
    });
</script>
<style>
    ...
    img[data-udrawsvg_template="template_preview"] {
        max-width: 100%;
        max-height: 100%;
		box-shadow: rgb(136 136 136) 0px 0px 7px 0px;
    }
