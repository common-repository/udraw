...
if (isset($_GET['udraw_svg_template_id']) && isset($_GET['udraw_svg_action'])) {
    if ($_GET['udraw_svg_action'] == "new-product") {
        $template_id = uDrawUtil::sanitize_variables($_GET['udraw_svg_template_id']);
...
<script>
    jQuery(document).ready(function($){
        ...
        var set_to_post_id = <?php echo uDrawUtil::esc_string($my_saved_attachment_post_id); ?>; // Set this
