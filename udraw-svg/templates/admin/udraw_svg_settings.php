...
<table class="form-table">
    <tbody>
        ...
        <tr valign="top" class="<?php echo uDrawUtil::esc_string($default_hidden) ?> default_skin">
        ...
        <tr valign="top" class="<?php uDrawUtil::esc_string($default_hidden) ?> default_skin">
            ...
            <td class="forminp forminp-checkbox">
                <fieldset>
                    ...
                    <input type="checkbox" name="udraw_SVGDesigner_tab_text_editor" <?php echo uDrawUtil::esc_string($tab_text_editor_checked); ?> />
                    <span class="description"><br><?php _e('Display the text editor in a tab instead of as an overlay box.', 'udraw_svg'); ?></span>
                </fieldset>
            </td>
        </tr>
        
        <tr valign="top" class="<?php echo uDrawUtil::esc_string($widescreen_hidden) ?> widescreen_skin">
            ...
            <td class="forminp forminp-checkbox">
                <fieldset>
                    ...
                    <input type="checkbox" name="udraw_SVGDesigner_load_tutorial" <?php echo uDrawUtil::esc_string($enable_tutorials); ?> />
        ...
        <tr valign="top">
            ...
            <td class="forminp forminp-checkbox">
                <fieldset>
                    ...
                    <input type="checkbox" name="udraw_SVGDesigner_display_proof" <?php echo uDrawUtil::esc_string($enable_proofing); ?> />
        ...
        <tr valign="top" class="" >
            ...
            <td class="forminp forminp-checkbox">
                <fieldset>
                    ...
                    <input type="checkbox" name="udraw_SVGDesigner_display_image_name" <?php echo uDrawUtil::esc_string($display_image_name); ?> />
        ...
        <tr valign="top" class="" >
            ...
            <td class="forminp forminp-checkbox">
                <fieldset>
                    ...
                    <input type="checkbox" name="udraw_SVGDesigner_enable_stock_images" <?php echo uDrawUtil::esc_string($stock_image_checked); ?> />
                    <span class="description"><br><?php _e('Allow users to add images from a selection of stock images.', 'udraw_svg'); ?></span>
                </fieldset>
            </td>
        </tr>
        <tr valign="top" class="<?php echo uDrawUtil::esc_string($stock_images_hidden) ?> stock_image_sources">
                ...
                <fieldset>
                    ...
                    <?php 
                        foreach ($sources_array as $source => $display) {
                            ...
                            echo uDrawUtil::esc_string($display);
                            echo '</div>';
                        }
                    ?>
        ...
        <tr valign="top" class="layers_tab_option <?php echo uDrawUtil::esc_string($layers_tab_hidden); ?>" >
            ...
            <td class="forminp forminp-checkbox">
                <fieldset>
                    ...
                    <input type="checkbox" name="udraw_SVGDesigner_display_layers" <?php echo uDrawUtil::esc_string($display_layers_checked); ?> />
                    <span class="description"><br><?php _e('Display the layers tab.', 'udraw_svg'); ?></span>
                </fieldset>
            </td>
        </tr>
        
        <tr valign="top" class="rulers_tab_option <?php echo uDrawUtil::esc_string($display_rulers); ?>" >
            ...
            <td class="forminp forminp-checkbox">
                <fieldset>
                    ...
                    <input type="checkbox" name="udraw_SVGDesigner_display_rulers" <?php echo uDrawUtil::esc_string($display_rulers_check); ?> />
            ...
            <td class="forminp forminp-checkbox">
                <fieldset>
                    ...
                    <?php if (version_compare(phpversion(), '7', '>=')) { ?>
                        <input type="checkbox" name="udraw_SVGDesigner_enable_dpi" <?php echo uDrawUtil::esc_string($dpi_checked); ?> />
                    <?php } else { ?>
                    <br/>
        ...
        <tr valign="top" class="udraw_svg_minimum_dpi <?php echo uDrawUtil::esc_string($dpi_display); ?>" >
            ...
            <td class="forminp forminp-checkbox">
                <fieldset>
                    ...
                    <input type="number" name="udraw_SVGDesigner_minimum_dpi" value="<?php echo uDrawUtil::esc_string($dpi_value); ?>" />
                </fieldset>
            </td>
        </tr>
        <?php } ?>
        <tr valign="top" class="">
            ...
            <td class="forminp forminp-checkbox">
                <fieldset>
                    ...
                    <input type="checkbox" name="udraw_SVGDesigner_embed_images" value="true" <?php echo uDrawUtil::esc_string($embed_images); ?> />
        ...
        <tr valign="top" class="">
            ...
            <td class="forminp forminp-checkbox">
                <fieldset>
                    ...
                    <input type="checkbox" name="udraw_svg_debug_pdf_production" value="true" <?php echo uDrawUtil::esc_string($debug_pdf); ?> />
        ...
        <tr valign="top" class="">
            ...
            <td class="forminp forminp-checkbox">
                <fieldset>
                    <textarea name="udraw_svg_css_hook" id="udraw_svg_css_hook" rows="7" cols="100" style="display:none;"><?php echo (htmlspecialchars($settings['udraw_svg_css_hook'], ENT_NOQUOTES)); ?></textarea>
        ...
        <tr valign="top" class="">
            ...
            <td class="forminp forminp-checkbox">
                <fieldset>
                    <textarea name="udraw_svg_js_hook" id="udraw_svg_js_hook" rows="7" cols="100" style="display:none;"><?php echo (htmlspecialchars($settings['udraw_svg_js_hook'], ENT_NOQUOTES)); ?></textarea>
