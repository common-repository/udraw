...
<div class="price_matrix_container">
    <form class="cart price_matrix_form variations_form" method="post" enctype='multipart/form-data'>
                ...
                <div id="udraw-price-matrix-ui-row" style="padding-top:10px;">
                    ...
                    <div class="divContainer">
							...
							<div class="Total" style="width:100%; text-align: right; padding-bottom: 10px !important;">
								<strong><?php _e('Price:', 'udraw') ?></strong>
								<span style="font-size: 18pt;color: rgb(0, 128, 0);font-weight: bold;">
									...
									<span id="totalPriceSymbol" style="font-size: 24px !important;"><?php echo uDrawUtil::esc_string(get_woocommerce_currency_symbol()); ?></span><span id="totalPrice" style="font-size: 24px !important;"><?php echo uDrawUtil::esc_string($product->regular_price); ?></span>
								</span>
							</div>					
                        </div>
                    </div>
        ...
        <table style="width: 100%;">
            <tr>
                <td>
                    <button type="submit" style="<?php echo htmlspecialchars($style, ENT_NOQUOTES); ?>" class="single_add_to_cart_button button alt"><?php esc_html_e( 'Update cart', 'woocommerce' ); ?></button>
    ...
    function display_udraw_price_matrix_preview() {
        ...
        priceMatrixObj = PriceMatrix({
            ...
            callback: function (obj) {
                ...
                AddSettings();
                if (!Boolean(<?php echo uDrawUtil::esc_string($from_cart); ?>)) {
        ...
        $(document).on('udraw_price_matrix_load_templates', function(event){
            if (event.svg_template_id) {
                ...
                if(saved_design_file.length > 0 && selectedByUser[0] === selectedDefault[0]) {
                    ...
                    $.ajax({
                        url: '<?php echo uDrawUtil::esc_string($ajax_url) ?>',
                        type: 'POST',
