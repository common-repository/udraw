...
if (!class_exists('uDraw_SVG')) {
    class uDraw_SVG {
        ...
        public function save_custom_fields($post_id, $post) {
            ...
            if ($SVG_product) {
                $template_id = (isset($_POST['udraw_SVG_template_id'])) ? uDrawUtil::sanitize_variables($_POST['udraw_SVG_template_id']) : '';
                ...
                if (isset($_POST['udraw_SVG_price_matrix_set'])) {
                    ...
                    if (isset($_POST['udraw_SVG_price_matrix_access_key'])) {
                        $access_key = uDrawUtil::sanitize_variables($_POST['udraw_SVG_price_matrix_access_key']);
                ...
                if (isset($_POST['udraw_SVG_selected_background_colour'])) {
                    $selected_background_colour = uDrawUtil::sanitize_variables($_POST['udraw_SVG_selected_background_colour']);
                }
                ...
                if (isset($_POST['udraw_SVG_use_background_image'])) {
                    ...
                    if (isset($_POST['udraw_SVG_selected_background_image'])) {
                        $selected_background_image = uDrawUtil::sanitize_variables($_POST['udraw_SVG_selected_background_image']);
                    }
                }
                
                $selected_editing_tips_colour = '#000';
                if (isset($_POST['udraw_SVG_editing_tips_colour'])) {
                    $selected_editing_tips_colour = uDrawUtil::sanitize_variables($_POST['udraw_SVG_editing_tips_colour']);
                }
        ...
        public function add_cart_item_data ($cart_item_meta, $product_id) {
            ...
            if (isset($_POST['udraw_SVG_product']) && $_POST['udraw_SVG_product']) {
                ...
                $session_id = uDrawUtil::sanitize_variables($_POST['udraw_SVG_session_id']);
                if (isset($design_data) && strlen($design_data) > 0) {
                    $cart_item_meta['udraw_SVG_data']['udraw_SVG_design_data'] = uDrawUtil::sanitize_variables($_POST['udraw_SVG_product_data']);
                    $cart_item_meta['udraw_SVG_data']['udraw_SVG_design_preview'] = uDrawUtil::sanitize_variables($_POST['udraw_SVG_product_preview']);
                    ...
                    if (substr($design_data, strlen($design_data) - 4) === 'json') {
                        ...
                        $contents = json_decode($uDrawUtil->get_web_contents($_url));
                    ...
                    for ($j = 0; $j < count($_folders); $j++) {
                        ...
                        for ($f = 0; $f < count($files); $f++) {
                            ...
                            if (isset($_pathinfo['extension']) && $_pathinfo['extension'] === 'json') {
                                ...
                                $has_json = true;
                                $file = str_replace(UDRAW_STORAGE_DIR, UDRAW_STORAGE_URL, $file);
                                $contents = json_decode($uDrawUtil->get_web_contents($file));
        ...
        public function register_bootstrap () {    
            ...
            wp_enquque_style('udraw_bootstrap_css');
