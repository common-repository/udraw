...
try {
  ...
  echo uDrawUtil::esc_string($error) . "\n";
  echo uDrawUtil::esc_string($error->getMessage()) . "\n";
  echo uDrawUtil::esc_string($error->getCode()) . "\n";
  echo uDrawUtil::esc_string($error->getResponseBody()) . "\n";
}
